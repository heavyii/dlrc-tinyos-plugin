 ...
 */
package tinyos.dlrc.preprocessor.parser;
...
import tinyos.dlrc.preprocessor.parser.stream.ElementStream;
...
public class CreateAndCheck {
    ...
    private static void create() throws Exception{
        ...
        tinyos.dlrc.preprocessor.lexer.CreateAndCheck.runMain( 
                "java_cup.Main",
                "-package", "tinyos.dlrc.preprocessor.parser",
                "-expect", "0",
                "-nopositions"
        ...
        // copy the files
        move( "parser.java", "src/tinyos/dlrc/preprocessor/parser/parser.java" );
        move( "sym.java", "src/tinyos/dlrc/preprocessor/parser/sym.java" );
    }
