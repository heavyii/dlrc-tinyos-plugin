 ...
 */
package tinyos.dlrc.preprocessor.expression;
...
public class CreateAndCheck {
    ...
    private static void createLexer(){
        String dir = "src/tinyos/dlrc/preprocessor/expression";
        String name = "bin/data/tinyos/preprocessor/expression_tokens.jflex";
        
        tinyos.dlrc.preprocessor.lexer.CreateAndCheck.runMain( "JFlex.Main", "-d", dir, name );
    }
    ...
    private static void createParser() throws Exception{
        ...
        tinyos.dlrc.preprocessor.lexer.CreateAndCheck.runMain( "java_cup.Main",
                "-package", "tinyos.dlrc.preprocessor.expression",
                "-expect", "0" );
        
        // copy the files
        move( "parser.java", "src/tinyos/dlrc/preprocessor/expression/parser.java" );
        move( "sym.java", "src/tinyos/dlrc/preprocessor/expression/sym.java" );
    }
