...
public class ReferencesRemovedSearchResultEvent  extends SearchResultEvent{
	private ASTReferenceSearchResult.Result[] references;
	
	public ReferencesRemovedSearchResultEvent( ISearchResult searchResult, ASTReferenceSearchResult.Result[] references ){
		super( searchResult );
