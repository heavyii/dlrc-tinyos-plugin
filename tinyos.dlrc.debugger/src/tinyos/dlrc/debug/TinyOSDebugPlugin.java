...
import tinyos.dlrc.debug.CDTAbstractionLayer.CDTVariableManager;
import tinyos.dlrc.debug.variables.INesCVariableListener;
import tinyos.dlrc.debug.variables.internal.NesCVariableListener;
...
public class TinyOSDebugPlugin extends AbstractUIPlugin {
	...
	/**
	 * The plug-in identifier (value <code>"tinyos.dlrc.debug"</code>).
	 */
	public static final String PLUGIN_ID = "tinyos.dlrc.debug";
