 ...
 */
package tinyos.dlrc.debug.variables.internal;
...
import tinyos.dlrc.debug.variables.INesCVariableListener;
import tinyos.dlrc.debug.variables.IVariableDescriptor;
import tinyos.dlrc.debug.variables.IVariableManager;
...
public class NesCVariableListener implements IDebugEventSetListener, INesCVariableListener {
	...
	/* (non-Javadoc)
	 * @see tinyos.dlrc.debug.util.variables.internal.INesCVariableListener#targetIsRunning()
	 */
	...
	/* (non-Javadoc)
	 * @see tinyos.dlrc.debug.util.variables.internal.INesCVariableListener#targetIsTerminated()
	 */
	...
	/* (non-Javadoc)
	 * @see tinyos.dlrc.debug.util.variables.internal.INesCVariableListener#stop()
	 */
	public void stop() {
