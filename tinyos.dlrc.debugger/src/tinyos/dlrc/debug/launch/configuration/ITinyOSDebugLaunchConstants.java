...
public interface ITinyOSDebugLaunchConstants {
	 ...
	 */
	public static final String TINYOS_DBG_LAUNCH_ID = "tinyos.dlrc.debug.launch"; //$NON-NLS-1$

	/**
	 * This is the launch type id.
	 */
	public static final String ID_LAUNCH_TINYOS_DEBUG = "tinyos.dlrc.debug.launch.configurationType"; //$NON-NLS-1$
