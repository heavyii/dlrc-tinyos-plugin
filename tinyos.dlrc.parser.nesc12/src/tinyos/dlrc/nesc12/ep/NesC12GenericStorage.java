...
import tinyos.dlrc.ep.storage.GenericStorage;
import tinyos.dlrc.ep.storage.IGenericFactory;
import tinyos.dlrc.nesc12.CancellationException;
import tinyos.dlrc.nesc12.ep.declarations.BaseDeclaration;
import tinyos.dlrc.nesc12.ep.declarations.EnumConstantDeclaration;
import tinyos.dlrc.nesc12.ep.declarations.FieldDeclaration;
import tinyos.dlrc.nesc12.ep.declarations.TypedDeclaration;
import tinyos.dlrc.nesc12.ep.nodes.BinaryComponentModelNode;
import tinyos.dlrc.nesc12.ep.nodes.ComponentModelNode;
import tinyos.dlrc.nesc12.ep.nodes.ComponentReferenceModelConnection;
import tinyos.dlrc.nesc12.ep.nodes.ConfigurationModelNode;
import tinyos.dlrc.nesc12.ep.nodes.ConnectionModelNode;
import tinyos.dlrc.nesc12.ep.nodes.DataObjectTypeModelConnection;
import tinyos.dlrc.nesc12.ep.nodes.DataObjectTypeModelNode;
import tinyos.dlrc.nesc12.ep.nodes.EndpointModelConnection;
import tinyos.dlrc.nesc12.ep.nodes.FieldModelConnection;
import tinyos.dlrc.nesc12.ep.nodes.FieldModelNode;
import tinyos.dlrc.nesc12.ep.nodes.GenericComponentModelNode;
import tinyos.dlrc.nesc12.ep.nodes.GenericTypeModelConnection;
import tinyos.dlrc.nesc12.ep.nodes.GenericTypeModelNode;
import tinyos.dlrc.nesc12.ep.nodes.InterfaceModelNode;
import tinyos.dlrc.nesc12.ep.nodes.InterfaceReferenceModelConnection;
import tinyos.dlrc.nesc12.ep.nodes.ModelAttribute;
import tinyos.dlrc.nesc12.ep.nodes.ModuleModelNode;
import tinyos.dlrc.nesc12.ep.nodes.NesC12TagSetFactory;
import tinyos.dlrc.nesc12.ep.nodes.TypedefModelConnection;
import tinyos.dlrc.nesc12.ep.nodes.TypedefModelNode;
import tinyos.dlrc.nesc12.ep.nodes.UnitModelNode;
import tinyos.dlrc.nesc12.parser.FileRegion;
import tinyos.dlrc.nesc12.parser.NesC12FileInfo;
import tinyos.dlrc.nesc12.parser.ast.elements.CombinedName;
import tinyos.dlrc.nesc12.parser.ast.elements.Field;
import tinyos.dlrc.nesc12.parser.ast.elements.LazyRangeDescription;
import tinyos.dlrc.nesc12.parser.ast.elements.Modifiers;
import tinyos.dlrc.nesc12.parser.ast.elements.Name;
import tinyos.dlrc.nesc12.parser.ast.elements.SimpleField;
import tinyos.dlrc.nesc12.parser.ast.elements.SimpleName;
import tinyos.dlrc.nesc12.parser.ast.elements.types.ArrayType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.BaseType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.ConstType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.DataObjectType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.EnumType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.FunctionType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.GenericType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.PointerType;
import tinyos.dlrc.nesc12.parser.ast.elements.types.TypeFactory;
import tinyos.dlrc.nesc12.parser.ast.elements.types.TypedefType;
import tinyos.dlrc.nesc12.parser.ast.elements.values.ArrayValue;
import tinyos.dlrc.nesc12.parser.ast.elements.values.DataObject;
import tinyos.dlrc.nesc12.parser.ast.elements.values.FloatingValue;
import tinyos.dlrc.nesc12.parser.ast.elements.values.IntegerValue;
import tinyos.dlrc.nesc12.parser.ast.elements.values.StringValue;
import tinyos.dlrc.nesc12.parser.ast.elements.values.UnknownValue;
import tinyos.dlrc.nesc12.parser.ast.elements.values.ValueFactory;
...
public class NesC12GenericStorage extends GenericStorage {
    ...
    protected void createFactories(){
        ...
        put( "tinyos.dlrc.nesc12.ep.nodes.ModelAttribute", ModelAttribute.class, ModelAttribute.FACTORY );
        put( "tinyos.dlrc.nesc12.ep.nodes.ModelAttribute[]", ModelAttribute[].class, ModelAttribute.ARRAY_FACTORY );
