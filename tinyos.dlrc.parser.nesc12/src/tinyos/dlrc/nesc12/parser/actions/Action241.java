...
public final class Action241 implements ParserAction{
 ...
 // n_attributes_no_init ::= n_attribute_no_init 
            {
              AttributeList RESULT =null;
		Attribute a = (Attribute)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AttributeList( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_attributes_no_init",147, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
