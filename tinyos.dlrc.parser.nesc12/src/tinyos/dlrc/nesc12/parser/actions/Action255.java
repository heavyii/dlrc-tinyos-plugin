 ...
 // n_datadef_list ::= n_datadef 
		...
		Datadef i = (Datadef)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DatadefList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_datadef_list",151, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
