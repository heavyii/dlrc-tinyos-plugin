...
public final class Action144 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error n_uses_or_provides_block 
            {
		...
		AccessList u = (AccessList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),null,null,u,parser.missing( "configuration", "implementation", u.getRange().getRight())); 			RESULT.setLeft( k.getLeft() ); 
