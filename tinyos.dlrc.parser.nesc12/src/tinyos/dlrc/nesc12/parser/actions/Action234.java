...
public final class Action234 implements ParserAction{
 ...
 // n_params ::= n_params P_COMMA n_param 
            {
              IdentifierParameterList RESULT =null;
		IdentifierParameterList s = (IdentifierParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		IdentifierParameter i = (IdentifierParameter)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_params",175, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
