 ...
 // c_designator_list ::= c_designator 
		...
		Designator d = (Designator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DesignatorList( d ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_designator_list",119, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
