...
public final class Action134 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION c_identifier n_component_parameters n_attributes_no_init 
            {
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,i,p,a,parser.missing( "configuration", "provides/uses block", a.getRange().getRight()),parser.missing( "configuration", "implementation", a.getRange().getRight())); 			RESULT.setLeft( k.getLeft() ); 
