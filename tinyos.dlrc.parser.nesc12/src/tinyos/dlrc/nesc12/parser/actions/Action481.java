...
public final class Action481 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_tn_nosc_rg ::= c_declaration_specifiers_notp_tn_nosc_norg c_storage_class_specifier_rg 
            {
