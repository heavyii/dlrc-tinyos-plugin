...
public final class Action707 implements ParserAction{
 ...
 // c_parameter_type_list ::= c_parameter_list P_COMMA P_ELLIPSIS 
            {
              ParameterTypeList RESULT =null;
		ParameterTypeList p = (ParameterTypeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = p; p.setOpenEnded( true );
			RESULT.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_parameter_type_list",107, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
