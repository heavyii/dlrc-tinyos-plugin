...
public final class Action327 implements ParserAction{
 ...
 // c_compound_literal ::= c_compound_literal_head c_curly_open c_initializer_list c_curly_close 
            {
              CompoundLiteral RESULT =null;
		CompoundLiteral h = (CompoundLiteral)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; h.setInitializer( i ); h.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_compound_literal",33, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
