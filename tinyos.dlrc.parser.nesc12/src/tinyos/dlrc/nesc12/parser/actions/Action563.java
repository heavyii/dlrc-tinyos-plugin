...
public final class Action563 implements ParserAction{
 ...
 // c_struct_declaration_list ::= c_struct_declaration_list error 
            {
		...
		DataObjectFieldDeclarationList s = (DataObjectFieldDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = s; s.addError( parser.errorNode( "declaration list", "declaration" )); 
