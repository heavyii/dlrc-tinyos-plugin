...
public final class Action223 implements ParserAction{
 ...
 // n_primary ::= n_parameterized_identifier 
            {
		...
		ParameterizedIdentifier p = (ParameterizedIdentifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NesCName( null, p ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_primary",195, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
