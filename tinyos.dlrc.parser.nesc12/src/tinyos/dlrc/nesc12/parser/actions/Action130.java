...
public final class Action130 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION c_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,i,null,null,parser.missing( "configuration", "provides/uses block", i.getRange().getRight()),parser.missing( "configuration", "implementation", i.getRange().getRight())); 			RESULT.setLeft( k.getLeft() ); 
