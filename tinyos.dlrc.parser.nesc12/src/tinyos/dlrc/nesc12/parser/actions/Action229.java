...
public final class Action229 implements ParserAction{
 ...
 // n_parameterized_identifier ::= c_all_identifier P_RECT_OPEN P_RECT_CLOSE 
            {
              ParameterizedIdentifier RESULT =null;
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Token ro = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterizedIdentifier( i, parser.missing( "parameterized identifier", "expression", ro.getLeft(), rr.getRight() ) );
			RESULT.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterized_identifier",187, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
