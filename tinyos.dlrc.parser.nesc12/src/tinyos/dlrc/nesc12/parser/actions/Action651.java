...
public final class Action651 implements ParserAction{
 ...
 // c_direct_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name n_interface_parameters c_round_open error c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 InterfaceDeclarator result = new InterfaceDeclarator( d, i, parser.errorNode( "interface field", "type list" ) ); 			RESULT = result; 			result.setRight( rr.getRight() ); 
