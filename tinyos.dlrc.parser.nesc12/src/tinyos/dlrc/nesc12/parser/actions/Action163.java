...
public final class Action163 implements ParserAction{
 ...
 // n_configuration_declarations ::= n_configuration_declarations n_configuration_declaration 
            {
              ConfigurationDeclarationList RESULT =null;
		ConfigurationDeclarationList s = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		ConfigurationDeclaration d = (ConfigurationDeclaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( d ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_configuration_declarations",182, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
