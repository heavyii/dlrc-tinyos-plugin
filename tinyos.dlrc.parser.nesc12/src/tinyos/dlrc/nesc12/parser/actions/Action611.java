		...
		Identifier e = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new EnumConstant( e, null );
			parser.scopes().addEnum( e.getName() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_enumerator",97, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
