...
public final class Action561 implements ParserAction{
 ...
 // c_struct_declaration_list ::= c_struct_declaration 
		...
		DataObjectFieldDeclaration i = (DataObjectFieldDeclaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DataObjectFieldDeclarationList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declaration_list",91, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
