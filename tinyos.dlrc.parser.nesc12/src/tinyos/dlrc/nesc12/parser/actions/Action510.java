...
public final class Action510 implements ParserAction{
 ...
 // c_storage_class_specifier_rg ::= K_REGISTER 
            {
		...
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new StorageClass( k, StorageClass.Storage.REGISTER ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_storage_class_specifier_rg",85, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
