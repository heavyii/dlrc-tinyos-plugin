...
public final class Action662 implements ParserAction{
 ...
 // c_direct_declarator_typedef_name ::= c_direct_declarator_typedef_name c_round_open c_parameter_type_list c_round_close 
            {
