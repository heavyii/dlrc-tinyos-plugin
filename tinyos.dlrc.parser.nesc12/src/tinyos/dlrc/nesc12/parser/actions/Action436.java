...
public final class Action436 implements ParserAction{
 ...
 // c_declaration_specifiers_nosc ::= c_declaration_specifiers_tp_notn_nosc 
            {
		...
		DeclarationSpecifierList d = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_nosc",63, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
