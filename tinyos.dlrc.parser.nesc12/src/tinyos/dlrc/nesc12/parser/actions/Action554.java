...
public final class Action554 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union NP_AT error 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
