...
public final class Action598 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM c_all_identifier n_attributes 
            {
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( i, a, null ); 			RESULT = declaration; 			declaration.setLeft(rl.getLeft()); 
