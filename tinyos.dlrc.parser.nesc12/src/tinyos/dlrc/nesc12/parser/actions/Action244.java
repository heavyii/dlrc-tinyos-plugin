...
public final class Action244 implements ParserAction{
 ...
 // n_attributes ::= n_attributes n_attribute 
            {
		...
		Attribute a = (Attribute)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_attributes",146, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
