...
public final class Action151 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error n_attributes_no_init n_uses_or_provides_block n_configuration_implementation 
            {
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),null,a,u,c); 			RESULT.setLeft( k.getLeft() ); 
