...
public final class Action403 implements ParserAction{
 ...
 // c_conditional_expression ::= c_conditional_expression_middle c_conditional_expression 
            {
              Expression RESULT =null;
		ConditionalExpression h = (ConditionalExpression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Expression f = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; h.setElseValue( f ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_conditional_expression",54, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
