...
public final class Action222 implements ParserAction{
 ...
 // n_primary ::= c_identifier P_POINT n_parameterized_identifier 
            {
              NesCName RESULT =null;
		Identifier e = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		ParameterizedIdentifier p = (ParameterizedIdentifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NesCName( e, p ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_primary",195, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
