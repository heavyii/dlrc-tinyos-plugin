...
public final class Action712 implements ParserAction{
 ...
 // c_parameter_declaration ::= c_declaration_specifiers_nosc 
            {
              ParameterDeclaration RESULT =null;
		DeclarationSpecifierList s = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterDeclaration( s, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_parameter_declaration",109, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
