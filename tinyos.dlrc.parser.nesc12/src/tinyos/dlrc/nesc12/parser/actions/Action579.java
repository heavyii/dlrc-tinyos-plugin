...
public final class Action579 implements ParserAction{
 ...
 // c_struct_declarator ::= c_declarator_typedef_name 
            {
		...
		Declarator d = (Declarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DataObjectFieldDeclarator( d, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declarator",94, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
