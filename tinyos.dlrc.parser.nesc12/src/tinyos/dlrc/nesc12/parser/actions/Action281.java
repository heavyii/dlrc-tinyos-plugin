...
public final class Action281 implements ParserAction{
 ...
 // n_parameterised_interface ::= n_datadef 
            {
              ASTNode RESULT =null;
		Datadef d = (Datadef)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterised_interface",169, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
