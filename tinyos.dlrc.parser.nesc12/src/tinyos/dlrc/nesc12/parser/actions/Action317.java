...
public final class Action317 implements ParserAction{
 ...
 // c_postfix_expression ::= n_call_kind error 
            {
              Expression RESULT =null;
		CallKind c = (CallKind)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
