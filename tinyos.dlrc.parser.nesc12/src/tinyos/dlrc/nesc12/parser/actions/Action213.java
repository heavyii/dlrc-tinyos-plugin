...
public final class Action213 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_all_identifier c_curly_open error c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new BinaryComponent( i, null, parser.errorNode( "binary component", "provides/uses block", op.getRight(), rr.getLeft() ) ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
