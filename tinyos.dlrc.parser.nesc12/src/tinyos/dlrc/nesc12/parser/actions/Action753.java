...
public final class Action753 implements ParserAction{
 ...
 // c_designation ::= c_all_identifier P_COLON 
            {
              DesignatorList RESULT =null;
		Identifier d = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
