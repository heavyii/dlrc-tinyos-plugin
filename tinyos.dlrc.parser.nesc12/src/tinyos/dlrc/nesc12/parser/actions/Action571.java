...
public final class Action571 implements ParserAction{
 ...
 // c_init_declarator ::= c_declarator_typedef_name c_asm_no_semicolon 
            {
		...
		ASMCall a = (ASMCall)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitDeclarator( d, a, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_init_declarator",87, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
