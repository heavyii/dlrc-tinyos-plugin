...
public final class Action401 implements ParserAction{
 ...
 // c_logical_or_expression ::= c_logical_or_expression P_OR error 
            {
              Expression RESULT =null;
		Expression o = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ArithmeticExpression( o, new ArithmeticOperator( p, ArithmeticOperator.Operator.OR ), parser.errorNode( "arithmetic expression", "right hand side expression" ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_logical_or_expression",53, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
