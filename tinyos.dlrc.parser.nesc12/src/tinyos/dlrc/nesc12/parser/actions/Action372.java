...
public final class Action372 implements ParserAction{
 ...
 // c_shift_expression ::= c_shift_expression c_shift_operator error 
            {
		...
		ArithmeticOperator p = (ArithmeticOperator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ArithmeticExpression( s, p, parser.errorNode( "arithmetic expression", "right hand side expression" ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_shift_expression",43, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
