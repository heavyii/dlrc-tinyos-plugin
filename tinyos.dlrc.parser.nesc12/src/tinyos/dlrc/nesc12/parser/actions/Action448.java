...
public final class Action448 implements ParserAction{
 ...
 // c_declaration_specifiers_tp_notn ::= c_declaration_specifiers_tp_notn_nosc_norg 
            {
		...
		DeclarationSpecifierList d = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_tp_notn",66, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
