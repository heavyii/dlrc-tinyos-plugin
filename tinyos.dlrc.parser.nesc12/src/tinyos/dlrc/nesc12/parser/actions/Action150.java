...
public final class Action150 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error n_component_parameters n_attributes_no_init 
            {
              Configuration RESULT =null;
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		TemplateParameterList p = (TemplateParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),p,a,parser.missing( "configuration", "provides/uses block", a.getRange().getRight()),parser.missing( "configuration", "implementation", a.getRange().getRight())); 			RESULT.setLeft( k.getLeft() ); 
