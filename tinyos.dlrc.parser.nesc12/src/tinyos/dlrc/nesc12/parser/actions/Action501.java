...
public final class Action501 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_notn_nosc_norg ::= c_extended_type_qualifier_list 
            {
              DeclarationSpecifierList RESULT =null;
		DeclarationSpecifierList t = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = t; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_notn_nosc_norg",79, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
