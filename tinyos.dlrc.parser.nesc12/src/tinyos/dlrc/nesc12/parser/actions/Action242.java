...
public final class Action242 implements ParserAction{
 ...
 // n_attributes_no_init ::= n_attributes_no_init n_attribute_no_init 
            {
              AttributeList RESULT =null;
		AttributeList s = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Attribute a = (Attribute)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_attributes_no_init",147, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
