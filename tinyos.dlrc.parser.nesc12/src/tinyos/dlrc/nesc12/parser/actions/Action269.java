...
public final class Action269 implements ParserAction{
 ...
 // n_uses ::= NK_USES n_parameterised_interface_list 
            {
              Access RESULT =null;
		...
		ParameterizedInterfaceList l = (ParameterizedInterfaceList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Access( Access.Direction.USES, l ); 
			RESULT.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_uses",165, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
