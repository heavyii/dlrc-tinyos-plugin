...
public final class Action604 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM error n_attributes c_curly_open c_enumerator_list c_curly_close 
            {
		...
		EnumConstantList e = (EnumConstantList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( parser.errorNode( "enum declaration", "identifier" ), a, e ); 			RESULT = declaration; 			declaration.setRanges( rl, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_enum_specifier",95, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
