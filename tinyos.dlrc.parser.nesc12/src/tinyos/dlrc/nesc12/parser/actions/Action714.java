...
public final class Action714 implements ParserAction{
 ...
 // c_all_identifier_list ::= c_all_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_all_identifier_list",111, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
