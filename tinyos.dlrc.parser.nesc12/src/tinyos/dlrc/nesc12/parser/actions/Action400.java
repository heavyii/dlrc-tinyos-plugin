...
public final class Action400 implements ParserAction{
 ...
 // c_logical_or_expression ::= c_logical_or_expression P_OR c_logical_and_expression 
            {
		...
		Expression a = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( o, new ArithmeticOperator( p, ArithmeticOperator.Operator.OR ), a ); 
