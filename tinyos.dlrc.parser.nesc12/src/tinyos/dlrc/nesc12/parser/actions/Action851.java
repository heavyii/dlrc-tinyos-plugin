...
public final class Action851 implements ParserAction{
 ...
 // c_external_declaration ::= n_configuration 
            {
              ExternalDeclaration RESULT =null;
		Configuration d = (Configuration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			parser.scopes().clean(); 	
 			RESULT = d; 
