 ...
 // c_init_declarator_list ::= c_init_declarator 
		...
		InitDeclarator i = (InitDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitDeclaratorList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_init_declarator_list",86, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
