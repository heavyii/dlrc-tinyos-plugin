...
public final class Action266 implements ParserAction{
 ...
 // n_uses_or_provides ::= n_datadef 
            {
              ASTNode RESULT =null;
		Datadef d = (Datadef)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_uses_or_provides",164, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
