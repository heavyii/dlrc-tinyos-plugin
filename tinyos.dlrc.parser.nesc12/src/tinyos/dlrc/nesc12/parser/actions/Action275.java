...
public final class Action275 implements ParserAction{
 ...
 // n_parameterised_interface_list ::= n_parameterised_interface 
            {
		...
		ASTNode p = (ASTNode)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterizedInterfaceList( p ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterised_interface_list",167, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
