...
public final class Action699 implements ParserAction{
 ...
 // c_type_qualifier_and_static_list ::= c_type_qualifier_and_static_list c_type_qualifier 
            {
		...
		TypeQualifier q = (TypeQualifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = t.add( q ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_type_qualifier_and_static_list",83, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
