...
public final class Action273 implements ParserAction{
 ...
 // n_provides ::= NK_PROVIDES c_curly_open c_curly_close 
            {
              Access RESULT =null;
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Access( Access.Direction.PROVIDES, new ParameterizedInterfaceList() );
			RESULT.setRanges( rl, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_provides",166, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
