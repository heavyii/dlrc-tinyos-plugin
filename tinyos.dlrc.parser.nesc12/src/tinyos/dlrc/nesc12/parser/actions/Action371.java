...
public final class Action371 implements ParserAction{
 ...
 // c_shift_expression ::= c_shift_expression c_shift_operator c_additive_expression 
            {
		...
		Expression a = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( s, p, a ); 
