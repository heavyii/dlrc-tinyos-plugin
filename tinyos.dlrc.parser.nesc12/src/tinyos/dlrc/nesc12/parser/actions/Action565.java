...
public final class Action565 implements ParserAction{
 ...
 // c_struct_declaration ::= c_declaration_specifiers c_semicolon 
            {
              DataObjectFieldDeclaration RESULT =null;
		DeclarationSpecifierList q = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DataObjectFieldDeclaration( q, new DataObjectFieldDeclaratorList() );
			RESULT.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declaration",92, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
