...
public final class Action230 implements ParserAction{
 ...
 // n_parameters ::= P_RECT_OPEN n_params P_RECT_CLOSE 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = p; p.setRanges( lr, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameters",174, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
