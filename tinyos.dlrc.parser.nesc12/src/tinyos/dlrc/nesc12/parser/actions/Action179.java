...
public final class Action179 implements ParserAction{
 ...
 // n_endpoint ::= error P_POINT error c_all_identifier P_POINT error 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = new Endpoint( parser.errorNode( "endpoint", "identifier" ), parser.errorNode( "endpoint", "parameterized identifier" ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_endpoint",186, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
