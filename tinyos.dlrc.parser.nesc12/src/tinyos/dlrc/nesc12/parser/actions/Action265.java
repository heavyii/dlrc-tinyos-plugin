...
public final class Action265 implements ParserAction{
 ...
 // n_uses_or_provides_list ::= n_uses_or_provides_list error 
            {
              AccessList RESULT =null;
		AccessList s = (AccessList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = s; s.addError( parser.errorNode( "uses/provides list", "uses, provides or typedef" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_uses_or_provides_list",163, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
