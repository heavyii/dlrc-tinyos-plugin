...
public final class Action494 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_notn_sc_norg ::= c_storage_class_specifier_norg 
            {
              DeclarationSpecifierList RESULT =null;
		StorageClass s = (StorageClass)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationSpecifierList( s ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_notn_sc_norg",77, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
