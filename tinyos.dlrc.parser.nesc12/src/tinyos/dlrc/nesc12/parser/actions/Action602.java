...
public final class Action602 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM c_all_identifier n_attributes c_curly_open error c_curly_close 
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( i, a, parser.errorNode( "enum declaration", "enum constant list" ) ); 			RESULT = declaration; 			declaration.setRanges( rl, rr ); 
