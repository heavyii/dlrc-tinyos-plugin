...
public final class Action162 implements ParserAction{
 ...
 // n_configuration_declarations ::= n_configuration_declaration 
            {
		...
		ConfigurationDeclaration d = (ConfigurationDeclaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ConfigurationDeclarationList( d ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_configuration_declarations",182, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
