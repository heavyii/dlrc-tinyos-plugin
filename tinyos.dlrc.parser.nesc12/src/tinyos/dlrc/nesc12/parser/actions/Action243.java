...
public final class Action243 implements ParserAction{
 ...
 // n_attributes ::= n_attribute 
            {
              AttributeList RESULT =null;
		Attribute a = (Attribute)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AttributeList( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_attributes",146, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
