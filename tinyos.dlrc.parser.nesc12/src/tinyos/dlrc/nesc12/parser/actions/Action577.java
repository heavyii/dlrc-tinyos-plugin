...
public final class Action577 implements ParserAction{
 ...
 // c_struct_declarator_list ::= c_struct_declarator_list P_COMMA c_struct_declarator 
            {
              DataObjectFieldDeclaratorList RESULT =null;
		DataObjectFieldDeclaratorList s = (DataObjectFieldDeclaratorList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		DataObjectFieldDeclarator i = (DataObjectFieldDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declarator_list",93, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
