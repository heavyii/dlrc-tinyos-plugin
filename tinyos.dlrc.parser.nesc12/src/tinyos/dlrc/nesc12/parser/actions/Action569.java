...
public final class Action569 implements ParserAction{
 ...
 // c_init_declarator_list ::= c_init_declarator_list P_COMMA error 
            {
              InitDeclaratorList RESULT =null;
		InitDeclaratorList s = (InitDeclaratorList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = s; s.addError( parser.errorNode( "declarator list", "declarator" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_init_declarator_list",86, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
