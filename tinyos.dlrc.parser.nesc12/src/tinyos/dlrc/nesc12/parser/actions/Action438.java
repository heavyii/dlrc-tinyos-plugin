...
public final class Action438 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_tn_nosc ::= c_declaration_specifiers_notp_tn_nosc_rg 
            {
		...
		DeclarationSpecifierList d = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_tn_nosc",64, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
