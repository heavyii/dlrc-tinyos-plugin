...
public final class Action298 implements ParserAction{
 ...
 // n_typelist ::= n_typelist P_COMMA 
            {
              TypeList RESULT =null;
		TypeList t = (TypeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = t.add( null );
			t.setRanges( null, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_typelist",172, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
