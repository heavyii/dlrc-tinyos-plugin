...
public final class Action706 implements ParserAction{
 ...
 // c_parameter_type_list ::= c_parameter_list 
            {
              ParameterTypeList RESULT =null;
		ParameterTypeList p = (ParameterTypeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = p; p.setOpenEnded( false ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_parameter_type_list",107, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
