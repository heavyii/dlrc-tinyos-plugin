...
public final class Action147 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error n_component_parameters n_attributes_no_init n_uses_or_provides_block n_configuration_implementation 
            {
              Configuration RESULT =null;
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),p,a,u,c); 			RESULT.setLeft( k.getLeft() ); 
