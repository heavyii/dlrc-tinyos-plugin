...
public final class Action849 implements ParserAction{
 ...
 // c_external_declaration ::= n_interface 
            {
              ExternalDeclaration RESULT =null;
		Interface d = (Interface)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			parser.scopes().clean(); 	
 			RESULT = d; 
