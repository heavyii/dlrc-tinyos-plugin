...
public final class Action499 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_notn_nosc_rg ::= c_declaration_specifiers_notp_notn_nosc_rg c_declaration_specifier_notp_notn_nosc_norg 
            {
		...
		DeclaratorSpecifier e = (DeclaratorSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d.add( e ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_notn_nosc_rg",78, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
