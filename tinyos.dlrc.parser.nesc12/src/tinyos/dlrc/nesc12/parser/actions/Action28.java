...
public final class Action28 implements ParserAction{
 ...
 // c_arrow_open_token ::= P_SMALLER 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	parser.scopes().push();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_arrow_open_token",20, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
