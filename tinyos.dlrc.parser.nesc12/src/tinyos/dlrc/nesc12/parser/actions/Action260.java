...
public final class Action260 implements ParserAction{
 ...
 // n_uses_or_provides_block ::= c_curly_open_recycle c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AccessList();
			RESULT.setRanges( rl, rr );  
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_uses_or_provides_block",162, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
