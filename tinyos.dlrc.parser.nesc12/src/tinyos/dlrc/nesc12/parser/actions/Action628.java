...
public final class Action628 implements ParserAction{
 ...
 // c_declarator_no_hidden_typedef_name ::= c_pointer c_direct_declarator_no_hidden_typedef_name n_attributes_no_init 
            {
              Declarator RESULT =null;
		Pointer p = (Pointer)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AttributedDeclarator( new PointerDeclarator( p, d ), a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declarator_no_hidden_typedef_name",100, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
