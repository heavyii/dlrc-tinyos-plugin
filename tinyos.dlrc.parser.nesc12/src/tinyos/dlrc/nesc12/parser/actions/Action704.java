 ...
 // c_type_qualifier_list ::= c_type_qualifier 
		...
		TypeQualifier t = (TypeQualifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationSpecifierList( t ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_type_qualifier_list",106, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
