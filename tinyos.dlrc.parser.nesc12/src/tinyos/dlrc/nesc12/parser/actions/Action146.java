...
public final class Action146 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error 
            {
              Configuration RESULT =null;
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),null,null,parser.missing( "configuration", "provides/uses block", k.getRight()),parser.missing( "configuration", "implementation", k.getRight())); 			RESULT.setLeft( k.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_configuration",180, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
