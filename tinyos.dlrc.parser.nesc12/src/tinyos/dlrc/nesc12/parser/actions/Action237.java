...
public final class Action237 implements ParserAction{
 ...
 // n_param ::= c_declaration_specifiers c_abstract_declarator n_attributes_no_init 
            {
              IdentifierParameter RESULT =null;
		DeclarationSpecifierList s = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		AbstractDeclarator d = (AbstractDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierParameter( s, d, a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_param",176, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
