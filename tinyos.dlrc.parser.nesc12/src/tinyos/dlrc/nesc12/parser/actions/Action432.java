...
public final class Action432 implements ParserAction{
 ...
 // c_declaration ::= c_declaration_specifiers c_init_declarator_list c_semicolon 
            {
              Declaration RESULT =null;
		DeclarationSpecifierList d = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		...
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Declaration( d, i ); RESULT.setRight( s.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration",61, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
