...
public final class Action203 implements ParserAction{
 ...
 // n_generic_arguments ::= n_generic_arguments P_COMMA n_generic_argument 
            {
              GenericArgumentList RESULT =null;
		GenericArgumentList g = (GenericArgumentList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		GenericArgument a = (GenericArgument)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = g.add( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_generic_arguments",192, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
