...
public final class Action133 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION c_identifier n_component_parameters n_attributes_no_init n_configuration_implementation 
            {
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,i,p,a,parser.missing( "configuration", "provides/uses block", a.getRange().getRight()),c); 			RESULT.setLeft( k.getLeft() ); 
