...
public final class Action304 implements ParserAction{
 ...
 // c_primary_expression ::= c_string_literal 
            {
              Expression RESULT =null;
		StringLiteralList s = (StringLiteralList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_primary_expression",31, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
