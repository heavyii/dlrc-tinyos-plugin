...
public final class Action316 implements ParserAction{
 ...
 // c_postfix_expression ::= n_call_kind n_primary c_round_open c_argument_expression_list c_round_close 
            {
              Expression RESULT =null;
		CallKind c = (CallKind)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		NesCName p = (NesCName)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		ArgumentExpressionList a = (ArgumentExpressionList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 CallExpression result = new CallExpression( c, p, a );
			...
			result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_postfix_expression",32, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
