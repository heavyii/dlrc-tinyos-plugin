...
public final class Action176 implements ParserAction{
 ...
 // n_endpoint ::= n_parameterized_identifier P_POINT n_parameterized_identifier 
            {
              Endpoint RESULT =null;
		ParameterizedIdentifier i = (ParameterizedIdentifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		ParameterizedIdentifier p = (ParameterizedIdentifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Endpoint( i, p ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_endpoint",186, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
