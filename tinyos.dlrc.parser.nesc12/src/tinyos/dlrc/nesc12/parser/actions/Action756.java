...
public final class Action756 implements ParserAction{
 ...
 // c_designator ::= P_RECT_OPEN c_constant_expression P_RECT_CLOSE 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayDesignator result = new ArrayDesignator( c );
			...
			result.setRanges( lr, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_designator",120, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
