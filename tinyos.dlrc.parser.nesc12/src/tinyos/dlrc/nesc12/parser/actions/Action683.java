...
public final class Action683 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name c_round_open c_parameter_type_list c_round_close 
            {
              Declarator RESULT =null;
		Declarator d = (Declarator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		ParameterTypeList p = (ParameterTypeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 FunctionDeclarator result = new FunctionDeclarator( d, p ); 			RESULT = result;  			result.setRight( rr.getRight() ); 
