...
public final class Action739 implements ParserAction{
 ...
 // c_direct_abstract_declarator ::= c_round_open c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 FunctionAbstractDeclarator result = new FunctionAbstractDeclarator();
			...
			result.setRanges( lr, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_direct_abstract_declarator",114, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
