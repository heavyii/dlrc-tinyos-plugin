...
public final class Action108 implements ParserAction{
 ...
 // n_configuration ::= NK_GENERIC NK_CONFIGURATION c_identifier n_component_parameters n_uses_or_provides_block 
            {
		...
		AccessList u = (AccessList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(true,i,p,null,u,parser.missing( "configuration", "implementation", u.getRange().getRight())); 			RESULT.setLeft( rl.getLeft() ); 
