...
public final class Action23 implements ParserAction{
 ...
 // c_round_open_token ::= P_ROUND_OPEN 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	parser.scopes().push();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_round_open_token",15, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
