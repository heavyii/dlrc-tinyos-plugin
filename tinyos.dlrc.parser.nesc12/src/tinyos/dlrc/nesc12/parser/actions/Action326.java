...
public final class Action326 implements ParserAction{
 ...
 // c_postfix_expression ::= c_compound_literal 
		...
		CompoundLiteral c = (CompoundLiteral)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = c; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_postfix_expression",32, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
