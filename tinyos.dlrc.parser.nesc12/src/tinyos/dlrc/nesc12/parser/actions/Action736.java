...
public final class Action736 implements ParserAction{
 ...
 // c_direct_abstract_declarator ::= c_direct_abstract_declarator c_round_open c_round_close 
            {
              AbstractDeclarator RESULT =null;
		AbstractDeclarator d = (AbstractDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 FunctionAbstractDeclarator result = new FunctionAbstractDeclarator( d, null );
			...
			result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_direct_abstract_declarator",114, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
