...
public final class Action166 implements ParserAction{
 ...
 // n_configuration_declaration ::= n_component_uses 
            {
              ConfigurationDeclaration RESULT =null;
		ComponentList u = (ComponentList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = u; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_configuration_declaration",183, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
