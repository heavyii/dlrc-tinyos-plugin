...
public final class Action143 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error n_uses_or_provides_block n_configuration_implementation 
            {
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),null,null,u,c); 			RESULT.setLeft( k.getLeft() ); 
