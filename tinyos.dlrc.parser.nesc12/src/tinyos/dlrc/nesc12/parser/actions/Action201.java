...
public final class Action201 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW error 
            {
              NewComponent RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new NewComponent( parser.missing( "new component", "identifier", rl.getRight() ), parser.errorNode( "new component", "generic argument list" ), null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rl.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_new_component_ref",191, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
