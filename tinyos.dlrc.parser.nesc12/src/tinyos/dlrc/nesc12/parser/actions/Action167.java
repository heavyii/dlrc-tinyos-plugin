...
public final class Action167 implements ParserAction{
 ...
 // n_connection ::= n_endpoint n_wire n_endpoint c_semicolon 
            {
              Connection RESULT =null;
		Endpoint a = (Endpoint)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		Wire w = (Wire)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Endpoint b = (Endpoint)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new Connection( a, w, b ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_connection",184, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
