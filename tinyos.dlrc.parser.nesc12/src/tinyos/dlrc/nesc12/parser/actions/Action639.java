...
public final class Action639 implements ParserAction{
 ...
 // c_direct_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name P_RECT_OPEN P_STAR P_RECT_CLOSE 
            {
