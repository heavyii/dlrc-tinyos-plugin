...
public final class Action198 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW error error 
            {
              NewComponent RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = new NewComponent( parser.errorNode( "new component", "identifier" ), parser.errorNode( "new component", "generic argument list" ), null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rl.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_new_component_ref",191, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
