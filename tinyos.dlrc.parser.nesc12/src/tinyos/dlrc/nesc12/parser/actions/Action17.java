...
public final class Action17 implements ParserAction{
 ...
 // c_curly_open_token ::= P_CURLY_OPEN 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	parser.scopes().push();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_curly_open_token",11, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
