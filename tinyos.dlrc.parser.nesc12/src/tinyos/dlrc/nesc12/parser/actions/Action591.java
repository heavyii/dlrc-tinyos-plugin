...
public final class Action591 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM c_all_identifier c_curly_open c_enumerator_list P_COMMA c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( i, null, e ); 			RESULT = declaration; 			declaration.setRanges( rl, rr ); 
