...
public final class Action665 implements ParserAction{
 ...
 // c_direct_declarator_typedef_name ::= c_direct_declarator_typedef_name c_round_open error c_round_close 
            {
