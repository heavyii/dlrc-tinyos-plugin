...
public final class Action391 implements ParserAction{
 ...
 // c_exclusive_or_expression ::= c_exclusive_or_expression P_CARET c_and_expression 
            {
		...
		Expression a = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( e, new ArithmeticOperator( p, ArithmeticOperator.Operator.BIT_XOR ), a ); 
