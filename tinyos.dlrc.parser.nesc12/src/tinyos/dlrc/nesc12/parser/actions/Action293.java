...
public final class Action293 implements ParserAction{
 ...
 // n_interface_type ::= NK_INTERFACE c_identifier c_arrow_open c_arrow_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InterfaceType( i, null );
			RESULT.setRanges( rl, rr );  
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_type",171, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
