...
public final class Action498 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_notn_nosc_rg ::= c_storage_class_specifier_rg 
            {
		...
		StorageClass s = (StorageClass)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationSpecifierList( s ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_notn_nosc_rg",78, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
