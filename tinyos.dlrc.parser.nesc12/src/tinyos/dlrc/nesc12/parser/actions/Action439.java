...
public final class Action439 implements ParserAction{
 ...
 // c_declaration_specifiers_tp_notn_nosc ::= c_declaration_specifiers_tp_notn_nosc_norg 
            {
              DeclarationSpecifierList RESULT =null;
		DeclarationSpecifierList d = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_tp_notn_nosc",65, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
