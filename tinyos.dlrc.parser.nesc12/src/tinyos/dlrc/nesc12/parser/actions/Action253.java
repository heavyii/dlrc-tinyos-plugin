...
public final class Action253 implements ParserAction{
 ...
 // n_attribute_initializer_list ::= c_round_open c_initializer_list P_COMMA c_round_close 
            {
              InitializerList RESULT =null;
		InitializerList l = (InitializerList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = l; 
