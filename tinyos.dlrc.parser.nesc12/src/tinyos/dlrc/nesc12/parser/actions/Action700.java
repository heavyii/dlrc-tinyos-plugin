		...
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Pointer();
			RESULT.setRanges( s, s ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_pointer",105, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
