...
public final class Action576 implements ParserAction{
 ...
 // c_struct_declarator_list ::= c_struct_declarator 
            {
		...
		DataObjectFieldDeclarator i = (DataObjectFieldDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DataObjectFieldDeclaratorList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declarator_list",93, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
