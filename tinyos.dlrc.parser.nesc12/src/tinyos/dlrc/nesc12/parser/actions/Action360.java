...
public final class Action360 implements ParserAction{
 ...
 // c_multiplicative_expression ::= c_multiplicative_expression c_multiplicative_operator c_cast_expression 
            {
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( m, p, e ); 
