...
public final class Action188 implements ParserAction{
 ...
 // n_component_ref ::= n_new_component_ref 
            {
              Component RESULT =null;
		NewComponent n = (NewComponent)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = n; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_component_ref",190, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
