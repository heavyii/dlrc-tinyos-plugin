...
public final class Action592 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM c_all_identifier c_curly_open error c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( i, null, parser.errorNode( "enum declaration", "enum constant list" ) ); 			RESULT = declaration; 			declaration.setRanges( rl, rr ); 
