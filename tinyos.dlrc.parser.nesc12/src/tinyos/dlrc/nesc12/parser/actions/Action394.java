...
public final class Action394 implements ParserAction{
 ...
 // c_inclusive_or_expression ::= c_inclusive_or_expression P_LINE c_exclusive_or_expression 
            {
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( i, new ArithmeticOperator( p, ArithmeticOperator.Operator.BIT_OR ), e ); 
