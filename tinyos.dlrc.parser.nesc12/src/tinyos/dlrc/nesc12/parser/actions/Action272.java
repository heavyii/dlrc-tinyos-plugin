...
public final class Action272 implements ParserAction{
 ...
 // n_provides ::= NK_PROVIDES n_parameterised_interface_list 
            {
              Access RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int lleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int lright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		ParameterizedInterfaceList l = (ParameterizedInterfaceList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Access( Access.Direction.PROVIDES, l ); 
			RESULT.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_provides",166, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
