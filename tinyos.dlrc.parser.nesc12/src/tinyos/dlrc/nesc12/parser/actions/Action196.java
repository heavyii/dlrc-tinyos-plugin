...
public final class Action196 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW error c_round_open n_generic_arguments c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NewComponent( parser.errorNode( "new component", "identifier" ), g, null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_new_component_ref",191, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
