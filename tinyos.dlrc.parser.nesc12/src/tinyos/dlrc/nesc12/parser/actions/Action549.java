...
public final class Action549 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union NP_AT c_all_identifier n_attributes_no_init c_curly_open c_curly_close 
            {
