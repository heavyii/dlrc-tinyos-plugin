...
public final class Action24 implements ParserAction{
 ...
 // c_round_close_remember ::= c_round_close 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 parser.scopes().remember();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_round_close_remember",18, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
