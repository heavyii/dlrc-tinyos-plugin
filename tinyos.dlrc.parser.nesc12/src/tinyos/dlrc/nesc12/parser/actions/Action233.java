...
public final class Action233 implements ParserAction{
 ...
 // n_params ::= n_param 
		...
		IdentifierParameter i = (IdentifierParameter)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierParameterList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_params",175, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
