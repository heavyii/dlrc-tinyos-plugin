...
public final class Action593 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM error 
            {
              TypeSpecifier RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 EnumDeclaration declaration = new EnumDeclaration( parser.errorNode( "enum declaration", "identifier and/or constant list" ), null, null ); 			RESULT = declaration; 			declaration.setLeft(rl.getLeft()); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_enum_specifier",95, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
