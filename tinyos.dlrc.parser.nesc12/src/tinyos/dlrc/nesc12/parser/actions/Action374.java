...
public final class Action374 implements ParserAction{
 ...
 // c_shift_operator ::= P_SHIFT_RIGHT 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticOperator( p, ArithmeticOperator.Operator.SHIFT_RIGHT ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_shift_operator",44, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
