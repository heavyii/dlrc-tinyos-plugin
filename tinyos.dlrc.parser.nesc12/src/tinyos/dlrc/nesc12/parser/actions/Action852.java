...
public final class Action852 implements ParserAction{
 ...
 // c_external_declaration ::= n_binary_component 
            {
              ExternalDeclaration RESULT =null;
		BinaryComponent d = (BinaryComponent)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			parser.scopes().clean(); 	
 			RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_external_declaration",136, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
