...
public final class Action251 implements ParserAction{
 ...
 // n_attribute_initializer_list ::= c_round_open c_initializer_list c_round_close 
            {
              InitializerList RESULT =null;
		InitializerList l = (InitializerList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = l; 
