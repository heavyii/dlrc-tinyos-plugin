...
public final class Action755 implements ParserAction{
 ...
 // c_designator_list ::= c_designator_list c_designator 
            {
              DesignatorList RESULT =null;
		DesignatorList l = (DesignatorList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Designator d = (Designator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = l.add( d ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_designator_list",119, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
