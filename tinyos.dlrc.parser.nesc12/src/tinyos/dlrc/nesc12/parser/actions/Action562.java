...
public final class Action562 implements ParserAction{
 ...
 // c_struct_declaration_list ::= c_struct_declaration_list c_struct_declaration 
            {
              DataObjectFieldDeclarationList RESULT =null;
		DataObjectFieldDeclarationList s = (DataObjectFieldDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		DataObjectFieldDeclaration i = (DataObjectFieldDeclaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declaration_list",91, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
