...
public final class Action588 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM c_all_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( i, null, null ); 			RESULT = declaration; 			declaration.setLeft(rl.getLeft()); 
