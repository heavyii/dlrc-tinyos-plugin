...
public final class Action257 implements ParserAction{
 ...
 // n_datadef_list ::= n_datadef_list error 
            {
              DatadefList RESULT =null;
		DatadefList s = (DatadefList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = s; s.addError( parser.errorNode( "declaration list", "declaration" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_datadef_list",151, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
