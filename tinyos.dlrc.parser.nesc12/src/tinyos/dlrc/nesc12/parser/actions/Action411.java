...
public final class Action411 implements ParserAction{
 ...
 // c_assignment_expression ::= c_unary_expression c_assignment_operator c_assignment_expression 
            {
              Expression RESULT =null;
		Expression u = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		AssignmentOperator o = (AssignmentOperator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AssignmentExpression( u, o, e ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_assignment_expression",57, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
