...
public final class Action225 implements ParserAction{
 ...
 // n_primary ::= c_identifier P_POINT 
            {
              NesCName RESULT =null;
		int eleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		Identifier e = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NesCName( e, parser.missing( null, "parameterized identifier", p.getRight() ) );
			RESULT.setRanges( eleft, pright ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_primary",195, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
