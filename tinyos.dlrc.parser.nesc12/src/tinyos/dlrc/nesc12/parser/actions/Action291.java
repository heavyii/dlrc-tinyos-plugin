...
public final class Action291 implements ParserAction{
 ...
 // n_interface_type ::= NK_INTERFACE error 
            {
		...
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new InterfaceType( parser.errorNode( "interface", "identifier" ), null );
			RESULT.setRanges( rlleft, rlright ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_type",171, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
