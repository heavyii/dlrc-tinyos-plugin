...
public final class Action226 implements ParserAction{
 ...
 // n_parameterized_identifier ::= c_all_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterizedIdentifier( i, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterized_identifier",187, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
