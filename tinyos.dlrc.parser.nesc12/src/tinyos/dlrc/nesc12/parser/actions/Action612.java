...
public final class Action612 implements ParserAction{
 ...
 // c_enumerator ::= c_all_identifier P_ASSIGN c_constant_expression 
            {
		...
		Expression c = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new EnumConstant( e, c );
			parser.scopes().addEnum( e.getName() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_enumerator",97, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
