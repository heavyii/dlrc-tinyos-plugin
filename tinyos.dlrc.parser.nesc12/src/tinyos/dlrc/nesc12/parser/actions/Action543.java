...
public final class Action543 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union error c_curly_open c_curly_close 
            {
              TypeSpecifier RESULT =null;
		DataObjectSpecifier s = (DataObjectSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 DataObjectDeclaration result = new DataObjectDeclaration( s, parser.errorNode( "data object declaration", "identifier or field declarations" ), null, null );	RESULT = result; result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_or_union_specifier",89, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
