...
public final class Action671 implements ParserAction{
 ...
 // c_direct_declarator_typedef_name ::= c_direct_declarator_typedef_name n_interface_parameters c_round_open error c_round_close 
            {
