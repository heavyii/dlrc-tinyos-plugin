...
public final class Action142 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION c_identifier n_component_parameters 
            {
		...
		TemplateParameterList p = (TemplateParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,i,p,null,parser.missing( "configuration", "provides/uses block", p.getRange().getRight()),parser.missing( "configuration", "implementation", p.getRange().getRight())); 			RESULT.setLeft( k.getLeft() ); 
