...
public final class Action8 implements ParserAction{
 ...
 // c_string_literal ::= STRING 
		...
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new StringLiteralList( new StringLiteral( s ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_string_literal",5, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
