...
public final class Action219 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_curly_open c_curly_close 
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new BinaryComponent( parser.missing( "binary component", "identifier", rl.getRight() ), null, null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
