...
public final class Action620 implements ParserAction{
 ...
 // c_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name 
            {
              Declarator RESULT =null;
		Declarator d = (Declarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declarator_no_typedef_name",101, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
