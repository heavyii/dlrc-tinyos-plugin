...
public final class Action355 implements ParserAction{
 ...
 // c_unary_operator ::= P_EXCLAMATION 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new UnaryOperator( p, UnaryOperator.Operator.NOT ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_unary_operator",37, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
