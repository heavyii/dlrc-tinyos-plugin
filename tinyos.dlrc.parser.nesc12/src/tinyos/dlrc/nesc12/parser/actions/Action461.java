...
public final class Action461 implements ParserAction{
 ...
 // c_declaration_specifiers_tp_notn_nosc_rg ::= c_declaration_specifiers_notp_notn_nosc_rg c_type_specifier_notn 
            {
		...
		TypeSpecifier e = (TypeSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d.add( e ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_tp_notn_nosc_rg",70, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
