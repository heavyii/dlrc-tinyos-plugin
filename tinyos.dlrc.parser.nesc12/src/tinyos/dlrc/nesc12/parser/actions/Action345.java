...
public final class Action345 implements ParserAction{
 ...
 // c_unary_expression ::= c_unary_operator c_cast_expression 
            {
              Expression RESULT =null;
		UnaryOperator u = (UnaryOperator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new PrefixExpression( u, e ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_unary_expression",36, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
