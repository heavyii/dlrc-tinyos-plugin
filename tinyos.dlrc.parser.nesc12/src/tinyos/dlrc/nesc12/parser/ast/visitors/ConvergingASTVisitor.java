 ...
 */
package tinyos.dlrc.nesc12.parser.ast.visitors;

import tinyos.dlrc.nesc12.parser.ast.ASTVisitor;
import tinyos.dlrc.nesc12.parser.ast.nodes.ASTNode;
import tinyos.dlrc.nesc12.parser.ast.nodes.ErrorASTNode;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ArrayAbstractDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ArrayDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ArrayDesignator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.AttributeDeclaration;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.AttributedDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DataObjectDeclaration;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DataObjectFieldDeclaration;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DataObjectFieldDeclarationList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DataObjectFieldDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DataObjectFieldDeclaratorList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DataObjectSpecifier;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.Declaration;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DeclarationSpecifierList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DeclaratorName;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DesignationInitializer;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DesignatorList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.DirectDeclaratorSpecifier;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.EnumConstant;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.EnumConstantList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.EnumDeclaration;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.EnumType;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.FieldDesignator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.FunctionAbstractDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.FunctionDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.IdentifierList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.IncompleteDataObject;
...
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.InitializerList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.InterfaceDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.MultiInitializer;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.NesCNameDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ParameterDeclaration;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ParameterTypeList;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ParameterizedDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ParenthesizedAbstractDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.ParenthesizedDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.Pointer;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.PointerAbstractDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.PointerDeclarator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.PrimitiveSpecifier;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.RangeDesignator;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.SingleInitializer;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.StorageClass;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.TypeName;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.TypeQualifier;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.TypedefName;
import tinyos.dlrc.nesc12.parser.ast.nodes.declaration.VariableLength;
import tinyos.dlrc.nesc12.parser.ast.nodes.definition.DeclarationList;
import tinyos.dlrc.nesc12.parser.ast.nodes.definition.FunctionDefinition;
import tinyos.dlrc.nesc12.parser.ast.nodes.definition.TranslationUnit;
...
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.ArithmeticOperator;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.ArraySubscripting;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.AssignmentExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.AssignmentOperator;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.CallExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.CallKind;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.CastExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.CharacterConstant;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.CompoundLiteral;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.ConditionalExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.EnumerationConstant;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.ExpressionList;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.FieldAccess;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.FloatingConstant;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.FunctionCall;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.IdentifierExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.IntegerConstant;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.ParenthesizedExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.PointerAccess;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.PostfixExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.PostfixOperator;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.PrefixExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.SizeofExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.StatementExpression;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.StringLiteral;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.StringLiteralList;
import tinyos.dlrc.nesc12.parser.ast.nodes.expression.UnaryOperator;
import tinyos.dlrc.nesc12.parser.ast.nodes.general.Identifier;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Access;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.AccessList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Attribute;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.AttributeList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.BinaryComponent;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.ComponentList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Configuration;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.ConfigurationDeclarationList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Connection;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Datadef;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.DatadefList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Endpoint;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.ExtensionExternalDefinition;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.GenericArgumentList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.IdentifierParameter;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.IdentifierParameterList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Includes;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Interface;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.InterfaceParameter;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.InterfaceParameterList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.InterfaceReference;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.InterfaceType;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Module;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.NesCExternalDefinitionList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.NesCName;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.NewComponent;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.ParameterizedIdentifier;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.ParameterizedInterface;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.ParameterizedInterfaceList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.RefComponent;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.TemplateParameter;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.TemplateParameterList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.TypeList;
import tinyos.dlrc.nesc12.parser.ast.nodes.nesc.Wire;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.ASMArgument;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.ASMArgumentList;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.ASMArgumentsList;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.ASMCall;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.AtomicStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.BreakStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.CaseStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.CompoundStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.ContinueStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.DefaultStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.DoWhileStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.EmptyStatement;
...
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.GotoStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.IfStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.LabeledStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.ReturnStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.SwitchStatement;
import tinyos.dlrc.nesc12.parser.ast.nodes.statement.WhileStatement;
