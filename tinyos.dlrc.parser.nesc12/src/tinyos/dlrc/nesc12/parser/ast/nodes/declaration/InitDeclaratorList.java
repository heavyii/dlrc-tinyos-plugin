...
public class InitDeclaratorList extends AbstractListASTNode<InitDeclarator>{
    public InitDeclaratorList(){
        super( "InitDeclaratorList" );
    }
    
    public InitDeclaratorList( InitDeclarator child ){
        this();
        add( child );
    }
    
    @Override
    public InitDeclaratorList add( InitDeclarator node ) {
        super.add( node );
        return this;
    }
    
    @Override
    protected void checkChild( InitDeclarator child ) throws ASTException {
