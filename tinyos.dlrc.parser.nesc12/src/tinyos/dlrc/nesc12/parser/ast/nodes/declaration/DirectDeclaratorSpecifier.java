...
public class DirectDeclaratorSpecifier extends AbstractTokenASTNode implements DeclaratorSpecifier{
    ...
    public DirectDeclaratorSpecifier( Token token, Specifier specifier ){
        super( "DirectDeclaratorSpecifier", token );
