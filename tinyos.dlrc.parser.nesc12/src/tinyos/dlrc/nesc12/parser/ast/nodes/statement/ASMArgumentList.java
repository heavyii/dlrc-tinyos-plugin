...
public class ASMArgumentList extends AbstractListASTNode<ASMArgument>{
    public ASMArgumentList(){
        super( "ASMArgumentList" );
    }
    
    public ASMArgumentList( ASMArgument child ){
        this();
        add( child );
    }
    
    @Override
    protected void checkChild( ASMArgument child ) throws ASTException{
        // nothing
    }
