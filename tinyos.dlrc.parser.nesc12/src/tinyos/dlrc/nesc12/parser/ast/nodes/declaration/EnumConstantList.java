...
public class EnumConstantList extends AbstractListASTNode<EnumConstant> {
    public EnumConstantList(){
        super( "EnumConstantList" );
    }
    
    public EnumConstantList( EnumConstant child ){
        this();
        add( child );
    }
    
    @Override
    public EnumConstantList add( EnumConstant node ) {
        super.add( node );
        return this;
    }
    
    @Override
    protected void checkChild( EnumConstant child ) throws ASTException {
    ...
    public void resolve( AnalyzeStack stack ) {
        ...
        super.resolve( stack );
        stack.remove( EnumConstant.LAST_ENUM_CONST );
    }
}
