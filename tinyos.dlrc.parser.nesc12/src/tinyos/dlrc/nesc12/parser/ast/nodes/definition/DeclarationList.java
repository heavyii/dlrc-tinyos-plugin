...
public class DeclarationList extends AbstractListASTNode<Declaration>{
    public DeclarationList(){
        super( "DeclarationList" );
    }
    
    public DeclarationList( Declaration child ){
        this();
        add( child );
    }

    @Override
    public DeclarationList add( Declaration node ) {
        super.add( node );
        return this;
    }
    
    @Override
    protected void checkChild( Declaration child ) throws ASTException {
