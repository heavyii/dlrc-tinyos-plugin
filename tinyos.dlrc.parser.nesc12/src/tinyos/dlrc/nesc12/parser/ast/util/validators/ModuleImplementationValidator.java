 ...
 */
package tinyos.dlrc.nesc12.parser.ast.util.validators;
...
import tinyos.dlrc.nesc12.parser.ast.util.DefaultModifierValidator;
import tinyos.dlrc.nesc12.parser.ast.util.messangers.FunctionMessanger;

public class ModuleImplementationValidator extends DefaultModifierValidator{
    @Override
    public void check( AnalyzeStack stack, DeclarationSpecifierList specifiers, InitDeclarator declaration ){
        ...
        if( type == null || type.asFunctionType() == null ){
            ...
            specifiers.checkModifiers(
                    stack, 
                    null,
                    Modifiers.ALL_TYPE_QUALIFIER | Modifiers.INLINE | Modifiers.NORACE,
                    Modifiers.ALL_NESC & ~Modifiers.NORACE,
            ...
            specifiers.checkModifiers(
                    stack, 
                    null,
                    Modifiers.ALL_TYPE_QUALIFIER | Modifiers.INLINE | Modifiers.ALL_NESC,
                    0,
                    new int[]{ Modifiers.ALL_STORAGE_CLASSES },
    ...
    public void check( AnalyzeStack stack, FunctionDefinition definition ){
        ...
        if( specifiers != null ){
            specifiers.checkModifiers(
                    stack, 
                    null,
                    Modifiers.CONST | Modifiers.VOLATILE | Modifiers.INLINE | Modifiers.ALL_NESC,
                    Modifiers.RESTRICT | Modifiers.REGISTER | Modifiers.TYPEDEF,
                    new int[]{ Modifiers.AUTO | Modifiers.STATIC | Modifiers.EXTERN },
