 ...
 */
package tinyos.dlrc.nesc12.parser.ast.util.pushers;

import tinyos.dlrc.nesc12.parser.ast.AnalyzeStack;
import tinyos.dlrc.nesc12.parser.ast.elements.Modifiers;

public class ComponentFieldPusher extends NesCFieldPusher{

    public ComponentFieldPusher( String name, AnalyzeStack stack ){
        super( name, stack );
    }
