...
public final class Action410 implements ParserAction{
 ...
 // n_endpoint ::= n_parameterized_identifier 
            {
              Endpoint RESULT =null;
		ParameterizedIdentifier i = (ParameterizedIdentifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Endpoint( i, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_endpoint",186, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
