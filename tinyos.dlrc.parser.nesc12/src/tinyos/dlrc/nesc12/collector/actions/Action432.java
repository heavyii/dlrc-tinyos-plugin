...
public final class Action432 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW error c_round_open c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NewComponent( parser.errorNode( "new component", "identifier" ), new GenericArgumentList(), null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
