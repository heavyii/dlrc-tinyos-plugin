...
public final class Action631 implements ParserAction{
 ...
 // c_logical_and_expression ::= c_inclusive_or_expression 
		...
		Expression i = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = i; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_logical_and_expression",52, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
