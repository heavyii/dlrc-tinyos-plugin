...
public final class Action583 implements ParserAction{
 ...
 // c_unary_expression ::= K_SIZEOF c_round_open c_type_name c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 SizeofExpression result = new SizeofExpression( t );
			...
			result.setRanges( rl, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_unary_expression",36, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
