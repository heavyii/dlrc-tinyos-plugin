...
public final class Action534 implements ParserAction{
 ...
 // n_typelist ::= n_typelist P_COMMA n_generic_type 
            {
              TypeList RESULT =null;
		TypeList t = (TypeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		TypeName g = (TypeName)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = t.add( g );
			t.setRanges( null, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_typelist",172, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
