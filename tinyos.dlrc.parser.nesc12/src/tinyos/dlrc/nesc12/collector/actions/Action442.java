...
public final class Action442 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_all_identifier n_attributes_no_init c_curly_open c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new BinaryComponent( i, a, null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
