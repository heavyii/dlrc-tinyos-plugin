...
public final class Action643 implements ParserAction{
 ...
 // c_conditional_expression_head ::= c_logical_or_expression P_QUESTION 
            {
		...
		Token q = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ConditionalExpression( c, null, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_conditional_expression_head",56, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
