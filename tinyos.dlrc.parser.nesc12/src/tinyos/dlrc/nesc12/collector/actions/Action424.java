...
public final class Action424 implements ParserAction{
 ...
 // n_component_ref ::= n_new_component_ref NK_AS c_all_identifier 
            {
              Component RESULT =null;
		NewComponent n = (NewComponent)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = n; n.setRename( i ); n.setRight( i.getRange().getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_component_ref",190, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
