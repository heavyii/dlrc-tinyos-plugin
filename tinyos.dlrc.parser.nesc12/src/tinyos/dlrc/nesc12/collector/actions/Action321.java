...
public final class Action321 implements ParserAction{
 ...
 // n_external_definitions ::= n_external_definition 
            {
              NesCExternalDefinitionList RESULT =null;
		NesCExternalDefinition i = (NesCExternalDefinition)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NesCExternalDefinitionList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_external_definitions",178, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
