...
public final class Action1065 implements ParserAction{
 ...
 // c_iteration_for_header ::= K_FOR c_round_open c_expression c_semicolon 
            {
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 ForStatement result = new ForStatement( e, null, null, null );
			...
			result.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_for_header",133, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
