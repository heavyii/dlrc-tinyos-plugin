...
public final class Action419 implements ParserAction{
 ...
 // n_component_list ::= n_component_list P_COMMA error 
            {
              ComponentList RESULT =null;
		ComponentList s = (ComponentList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = s; s.addError( parser.errorNode( "list of components", "component" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_component_list",189, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
