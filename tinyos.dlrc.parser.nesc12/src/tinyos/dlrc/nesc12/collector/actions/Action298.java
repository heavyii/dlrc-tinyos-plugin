...
public final class Action298 implements ParserAction{
 ...
 // n_module_head_attributes ::= n_module_head 
            {
              Module RESULT =null;
		Module h = (Module)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_head_attributes",156, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
