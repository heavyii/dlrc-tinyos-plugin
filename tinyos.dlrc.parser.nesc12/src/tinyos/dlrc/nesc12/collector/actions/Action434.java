...
public final class Action434 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW c_round_open n_generic_arguments c_round_close 
            {
              NewComponent RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		GenericArgumentList g = (GenericArgumentList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NewComponent( parser.missing( "new component", "identifier", rl.getRight() ), g, null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_new_component_ref",191, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
