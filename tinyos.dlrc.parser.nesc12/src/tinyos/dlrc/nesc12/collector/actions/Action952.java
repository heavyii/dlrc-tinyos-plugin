...
public final class Action952 implements ParserAction{
 ...
 // c_identifier_list ::= c_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_identifier_list",110, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
