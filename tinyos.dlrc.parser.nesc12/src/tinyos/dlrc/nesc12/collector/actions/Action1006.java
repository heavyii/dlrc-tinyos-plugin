...
public final class Action1006 implements ParserAction{
 ...
 // c_labeled_statement ::= K_CASE c_constant_expression P_COLON c_statement 
            {
              Statement RESULT =null;
		Token lr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Statement s = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 CaseStatement result = new CaseStatement( lr, e, s );
			RESULT = result;
			result.setLeft( lr.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_labeled_statement",122, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
