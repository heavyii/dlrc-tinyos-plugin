...
public final class Action446 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_all_identifier c_curly_open c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new BinaryComponent( i, null, null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
