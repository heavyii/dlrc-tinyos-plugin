...
public final class Action505 implements ParserAction{
 ...
 // n_uses ::= NK_USES c_curly_open c_curly_close 
            {
              Access RESULT =null;
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Access( Access.Direction.USES, new ParameterizedInterfaceList() );
			RESULT.setRanges( rl, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_uses",165, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
