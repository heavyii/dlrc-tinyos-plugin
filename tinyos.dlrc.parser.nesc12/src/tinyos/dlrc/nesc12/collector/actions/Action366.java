...
public final class Action366 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION c_identifier n_component_parameters n_attributes_no_init n_uses_or_provides_block n_configuration_implementation 
            {
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,i,p,a,u,c); 			RESULT.setLeft( k.getLeft() ); 
