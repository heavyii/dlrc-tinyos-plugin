...
public final class Action838 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM error n_attributes 
            {
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( parser.errorNode( "enum declaration", "identifier" ), a, null ); 			RESULT = declaration; 			declaration.setLeft(rl.getLeft()); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_enum_specifier",95, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
