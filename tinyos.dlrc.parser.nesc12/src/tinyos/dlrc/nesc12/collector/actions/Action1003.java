...
public final class Action1003 implements ParserAction{
 ...
 // c_statement ::= n_atomic_statement 
            {
              Statement RESULT =null;
		AtomicStatement s = (AtomicStatement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_statement",121, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
