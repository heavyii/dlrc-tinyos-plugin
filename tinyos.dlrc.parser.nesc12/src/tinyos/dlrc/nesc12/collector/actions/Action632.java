...
public final class Action632 implements ParserAction{
 ...
 // c_logical_and_expression ::= c_logical_and_expression P_AND c_inclusive_or_expression 
            {
		...
		Expression i = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( l, new ArithmeticOperator( p, ArithmeticOperator.Operator.AND ), i ); 
