...
public final class Action1021 implements ParserAction{
 ...
 // c_asm_no_semicolon ::= K_ASM K_VOLATILE c_asm_args 
            {
              ASMCall RESULT =null;
		...
		ASMArgumentsList a = (ASMArgumentsList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ASMCall result = new ASMCall( true, a );
			...
			RESULT = result; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_no_semicolon",26, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
