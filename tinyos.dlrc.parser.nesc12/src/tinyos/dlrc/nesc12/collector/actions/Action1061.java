...
public final class Action1061 implements ParserAction{
 ...
 // c_iteration_for_condition ::= c_iteration_for_header c_expression c_semicolon 
            {
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = h; h.setCondition( e ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_for_condition",132, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
