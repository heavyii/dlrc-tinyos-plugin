...
public final class Action1043 implements ParserAction{
 ...
 // c_selection_statement ::= K_SWITCH c_round_open error c_round_close c_statement 
            {
		...
		Token rc = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Statement s = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 SwitchStatement result = new SwitchStatement( parser.errorNode( "switch header", "expression", ro.getRight(), rc.getLeft()), s );
			...
			result.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_selection_statement",128, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
