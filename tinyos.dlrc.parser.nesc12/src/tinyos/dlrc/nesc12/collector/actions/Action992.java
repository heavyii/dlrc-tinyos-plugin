...
public final class Action992 implements ParserAction{
 ...
 // c_designator ::= P_RECT_OPEN c_constant_expression P_ELLIPSIS c_constant_expression P_RECT_CLOSE 
            {
              Designator RESULT =null;
		Token lr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RangeDesignator result = new RangeDesignator( a, b );
			...
			result.setRanges( lr, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_designator",120, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
