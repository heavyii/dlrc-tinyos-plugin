...
public final class Action12 implements ParserAction{
 ...
 // c_constant ::= c_enumeration_constant 
		...
		EnumerationConstant e = (EnumerationConstant)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = e; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_constant",4, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
