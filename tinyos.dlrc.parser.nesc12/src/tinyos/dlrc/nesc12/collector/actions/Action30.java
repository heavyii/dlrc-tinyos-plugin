...
public final class Action30 implements ParserAction{
 ...
 // c_arrow_close_token ::= P_GREATER 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	parser.scopes().pop();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_arrow_close_token",22, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
