...
public final class Action531 implements ParserAction{
 ...
 // n_typelist ::= n_generic_type 
            {
              TypeList RESULT =null;
		TypeName t = (TypeName)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new TypeList( t ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_typelist",172, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
