...
public final class Action320 implements ParserAction{
 ...
 // n_module_implementation ::= NK_IMPLEMENTATION error 
            {
		...
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new NesCExternalDefinitionList(); 
			...
			RESULT.setRanges( rl, rl ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_implementation",177, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
