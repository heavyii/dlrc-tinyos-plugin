...
public final class Action1057 implements ParserAction{
 ...
 // c_iteration_for_update ::= K_FOR c_round_open c_expression c_round_close 
            {
		...
		Token rc = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ForStatement( e, parser.missing( "for statement", "expression", rc.getLeft() ), null, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_for_update",131, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
