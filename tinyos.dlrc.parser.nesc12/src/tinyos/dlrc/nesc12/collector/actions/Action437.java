...
public final class Action437 implements ParserAction{
 ...
 // n_generic_arguments ::= n_generic_argument 
            {
              GenericArgumentList RESULT =null;
		GenericArgument g = (GenericArgument)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new GenericArgumentList( g ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_generic_arguments",192, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
