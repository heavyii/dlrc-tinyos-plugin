...
public final class Action1015 implements ParserAction{
 ...
 // c_block_item_list ::= c_block_item_list c_block_item 
            {
              CompoundStatement RESULT =null;
		CompoundStatement l = (CompoundStatement)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Statement i = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = l.add( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_block_item_list",125, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
