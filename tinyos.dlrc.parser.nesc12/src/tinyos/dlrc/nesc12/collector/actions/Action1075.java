...
public final class Action1075 implements ParserAction{
 ...
 // n_atomic_statement ::= NK_ATOMIC c_statement 
            {
              AtomicStatement RESULT =null;
		...
		Statement s = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AtomicStatement( s );
			RESULT.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_atomic_statement",196, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
