...
public final class Action975 implements ParserAction{
 ...
 // c_initializer ::= c_assignment_expression 
            {
		...
		Expression a = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new SingleInitializer( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_initializer",116, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
