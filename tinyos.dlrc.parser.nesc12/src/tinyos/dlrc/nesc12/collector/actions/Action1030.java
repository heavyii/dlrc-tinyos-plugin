...
public final class Action1030 implements ParserAction{
 ...
 // c_asm_arg ::= c_string_literal 
            {
              ASMArgument RESULT =null;
		StringLiteralList l = (StringLiteralList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ASMArgument( l, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_arg",30, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
