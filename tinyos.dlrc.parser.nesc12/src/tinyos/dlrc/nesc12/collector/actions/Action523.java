...
public final class Action523 implements ParserAction{
 ...
 // n_interface_ref ::= n_interface_type 
            {
              InterfaceReference RESULT =null;
		InterfaceType t = (InterfaceType)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InterfaceReference( t, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_ref",170, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
