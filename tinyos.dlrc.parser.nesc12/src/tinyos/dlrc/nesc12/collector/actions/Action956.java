...
public final class Action956 implements ParserAction{
 ...
 // c_type_name ::= c_declaration_specifiers c_abstract_declarator 
            {
		...
		AbstractDeclarator a = (AbstractDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new TypeName( s, a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_type_name",112, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
