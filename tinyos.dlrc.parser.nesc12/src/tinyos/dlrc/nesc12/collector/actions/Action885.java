...
public final class Action885 implements ParserAction{
 ...
 // c_direct_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name n_interface_parameters c_round_open n_params c_round_close 
            {
              Declarator RESULT =null;
		Declarator d = (Declarator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		InterfaceParameterList i = (InterfaceParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		IdentifierParameterList p = (IdentifierParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 InterfaceDeclarator result = new InterfaceDeclarator( d, i, p ); 			RESULT = result; 			result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_direct_declarator_no_typedef_name",104, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
