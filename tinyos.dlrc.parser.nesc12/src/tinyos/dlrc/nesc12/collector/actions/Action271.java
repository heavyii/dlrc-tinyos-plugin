...
public final class Action271 implements ParserAction{
 ...
 // n_interface ::= n_interface_head_parameters c_curly_open_recycle n_datadef_list c_curly_close 
            {
              Interface RESULT =null;
		Interface h = (Interface)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		DatadefList d = (DatadefList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	RESULT = h; 
			h.setBody( d ); 
			h.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface",140, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
