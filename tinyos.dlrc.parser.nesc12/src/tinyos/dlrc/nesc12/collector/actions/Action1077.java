...
public final class Action1077 implements ParserAction{
 ...
 // c_translation_unit ::= c_translation_unit c_external_declaration 
            {
              TranslationUnit RESULT =null;
		TranslationUnit s = (TranslationUnit)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		ExternalDeclaration i = (ExternalDeclaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_translation_unit",135, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
