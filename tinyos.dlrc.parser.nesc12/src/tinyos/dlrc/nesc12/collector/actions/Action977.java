...
public final class Action977 implements ParserAction{
 ...
 // c_initializer ::= c_curly_open c_initializer_list P_COMMA c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 MultiInitializer result = new MultiInitializer( i );
			...
			result.setRanges( lr, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_initializer",116, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
