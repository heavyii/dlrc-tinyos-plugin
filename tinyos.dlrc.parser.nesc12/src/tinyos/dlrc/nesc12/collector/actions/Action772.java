...
public final class Action772 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union c_curly_open c_curly_close 
            {
              TypeSpecifier RESULT =null;
		DataObjectSpecifier s = (DataObjectSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 DataObjectDeclaration result = new DataObjectDeclaration( s, null, null, null );	RESULT = result; result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_or_union_specifier",89, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
