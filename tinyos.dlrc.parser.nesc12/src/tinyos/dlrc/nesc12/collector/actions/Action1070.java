...
public final class Action1070 implements ParserAction{
 ...
 // c_jump_statement ::= K_CONTINUE c_semicolon 
            {
		...
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ContinueStatement( k ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_jump_statement",134, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
