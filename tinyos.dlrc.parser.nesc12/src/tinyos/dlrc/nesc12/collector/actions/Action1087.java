...
public final class Action1087 implements ParserAction{
 ...
 // c_declaration_list ::= c_declaration 
		...
		Declaration i = (Declaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_list",138, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
