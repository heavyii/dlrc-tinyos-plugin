...
public final class Action601 implements ParserAction{
 ...
 // c_additive_expression ::= c_additive_expression c_additive_operator c_multiplicative_expression 
            {
		...
		Expression m = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( a, p, m ); 
