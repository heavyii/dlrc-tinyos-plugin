...
public final class Action351 implements ParserAction{
 ...
 // n_configuration ::= NK_GENERIC NK_CONFIGURATION error n_component_parameters n_attributes_no_init n_uses_or_provides_block 
            {
		...
		AccessList u = (AccessList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(true,parser.errorNode( "configuration", "identifier" ),p,a,u,parser.missing( "configuration", "implementation", u.getRange().getRight())); 			RESULT.setLeft( rl.getLeft() ); 
