...
public final class Action274 implements ParserAction{
 ...
 // n_interface_head_parameters ::= n_interface_head 
            {
              Interface RESULT =null;
		Interface h = (Interface)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_head_parameters",141, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
