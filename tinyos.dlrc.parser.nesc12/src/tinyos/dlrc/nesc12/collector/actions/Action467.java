...
public final class Action467 implements ParserAction{
 ...
 // n_parameters ::= P_RECT_OPEN error P_RECT_CLOSE 
            {
              IdentifierParameterList RESULT =null;
		int lrleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierParameterList();
			RESULT.setRanges( lrleft, rrright );;
