...
public final class Action288 implements ParserAction{
 ...
 // n_interface_parameter ::= c_all_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new InterfaceParameter( i, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_parameter",145, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
