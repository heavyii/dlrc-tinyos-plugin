...
public final class Action799 implements ParserAction{
 ...
 // c_struct_declaration ::= c_declaration_specifiers c_struct_declarator_list c_semicolon 
            {
              DataObjectFieldDeclaration RESULT =null;
		DeclarationSpecifierList q = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		DataObjectFieldDeclaratorList d = (DataObjectFieldDeclaratorList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DataObjectFieldDeclaration( q, d );
			RESULT.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declaration",92, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
