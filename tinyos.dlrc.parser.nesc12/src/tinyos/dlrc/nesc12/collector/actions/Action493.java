...
public final class Action493 implements ParserAction{
 ...
 // n_datadef ::= c_declaration 
            {
              Datadef RESULT =null;
		Declaration d = (Declaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Datadef( d ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_datadef",152, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
