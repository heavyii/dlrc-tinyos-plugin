...
public final class Action279 implements ParserAction{
 ...
 // n_interface_head ::= NK_INTERFACE c_all_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Interface( i, null, null, null ); 
			RESULT.setLeft( k.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_head",142, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
