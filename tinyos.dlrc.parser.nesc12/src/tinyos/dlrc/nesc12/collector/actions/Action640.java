...
public final class Action640 implements ParserAction{
 ...
 // c_conditional_expression_middle ::= c_conditional_expression_head c_expression P_COLON 
            {
              ConditionalExpression RESULT =null;
		ConditionalExpression h = (ConditionalExpression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; h.setIfValue( t ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_conditional_expression_middle",55, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
