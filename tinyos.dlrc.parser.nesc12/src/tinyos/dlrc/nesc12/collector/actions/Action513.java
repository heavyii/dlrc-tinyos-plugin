...
public final class Action513 implements ParserAction{
 ...
 // n_parameterised_interfaces ::= n_parameterised_interface 
            {
              ParameterizedInterfaceList RESULT =null;
		ASTNode i = (ASTNode)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterizedInterfaceList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterised_interfaces",168, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
