...
public final class Action930 implements ParserAction{
 ...
 // c_array_declarator_qualifiers ::= c_type_qualifier_and_static_list 
            {
		...
		DeclarationSpecifierList t = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = t; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_array_declarator_qualifiers",82, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
