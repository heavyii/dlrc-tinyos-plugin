...
public final class Action738 implements ParserAction{
 ...
 // c_extended_type_qualifier_list ::= K_DEFAULT 
            {
		...
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationSpecifierList( new DirectDeclaratorSpecifier( k, DirectDeclaratorSpecifier.Specifier.DEFAULT ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_extended_type_qualifier_list",81, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
