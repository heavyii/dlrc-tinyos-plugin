...
public final class Action2 implements ParserAction{
 ...
 // c_typedef_name ::= TYPEDEF 
            {
              TypedefName RESULT =null;
		Token t = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new TypedefName( new Identifier( t )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_typedef_name",115, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
