...
public final class Action866 implements ParserAction{
 ...
 // c_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name n_attributes_no_init 
            {
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AttributedDeclarator( d, a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declarator_no_hidden_typedef_name",100, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
