		...
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Interface( parser.missing( "interface", "identifier", k.getRight() ), null, null, null ); 
			RESULT.setLeft( k.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_head",142, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
