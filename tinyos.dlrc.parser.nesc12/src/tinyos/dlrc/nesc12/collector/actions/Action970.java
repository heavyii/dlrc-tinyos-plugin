...
public final class Action970 implements ParserAction{
 ...
 // c_direct_abstract_declarator ::= c_direct_abstract_declarator c_round_open c_parameter_type_list c_round_close 
            {
              AbstractDeclarator RESULT =null;
		AbstractDeclarator d = (AbstractDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 FunctionAbstractDeclarator result = new FunctionAbstractDeclarator( d, p );
			...
			result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_direct_abstract_declarator",114, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
