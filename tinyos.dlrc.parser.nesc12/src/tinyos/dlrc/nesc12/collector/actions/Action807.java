...
public final class Action807 implements ParserAction{
 ...
 // c_init_declarator ::= c_declarator_typedef_name P_ASSIGN c_initializer 
            {
		...
		Initializer i = (Initializer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitDeclarator( d, null, i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_init_declarator",87, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
