...
public final class Action380 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error n_configuration_implementation 
            {
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),null,null,parser.missing( "configuration", "provides/uses block", k.getRight()),c); 			RESULT.setLeft( k.getLeft() ); 
