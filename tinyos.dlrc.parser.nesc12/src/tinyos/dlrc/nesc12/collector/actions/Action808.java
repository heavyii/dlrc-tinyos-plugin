...
public final class Action808 implements ParserAction{
 ...
 // c_init_declarator ::= c_declarator_typedef_name c_asm_no_semicolon P_ASSIGN c_initializer 
            {
		...
		ASMCall a = (ASMCall)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Initializer i = (Initializer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitDeclarator( d, a, i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_init_declarator",87, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
