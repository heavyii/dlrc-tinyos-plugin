...
public final class Action878 implements ParserAction{
 ...
 // c_direct_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name c_round_open c_identifier_list c_round_close 
            {
