...
public final class Action980 implements ParserAction{
 ...
 // c_initializer_list ::= c_initializer 
            {
		...
		Initializer i = (Initializer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitializerList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_initializer_list",117, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
