...
public final class Action315 implements ParserAction{
 ...
 // n_template_parameter ::= K_TYPEDEF c_identifier n_attributes_no_init 
            {
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new TemplateParameter( k, i, a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_template_parameter",161, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
