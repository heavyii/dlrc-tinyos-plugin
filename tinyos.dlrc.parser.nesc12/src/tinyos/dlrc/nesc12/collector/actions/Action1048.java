...
public final class Action1048 implements ParserAction{
 ...
 // c_iteration_statement ::= c_iteration_do_header K_WHILE error c_semicolon 
            {
              Statement RESULT =null;
		DoWhileStatement h = (DoWhileStatement)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 DoWhileStatement result = h;
			...
			h.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_statement",129, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
