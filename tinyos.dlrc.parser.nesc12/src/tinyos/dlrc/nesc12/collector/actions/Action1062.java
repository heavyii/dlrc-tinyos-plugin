...
public final class Action1062 implements ParserAction{
 ...
 // c_iteration_for_condition ::= c_iteration_for_header c_semicolon 
            {
		...
		ForStatement h = (ForStatement)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = h; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_for_condition",132, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
