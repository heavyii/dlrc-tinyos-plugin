...
public final class Action524 implements ParserAction{
 ...
 // n_interface_ref ::= n_interface_type NK_AS c_all_identifier 
            {
              InterfaceReference RESULT =null;
		InterfaceType t = (InterfaceType)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InterfaceReference( t, i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_ref",170, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
