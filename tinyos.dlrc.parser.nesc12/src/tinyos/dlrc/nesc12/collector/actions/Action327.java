...
public final class Action327 implements ParserAction{
 ...
 // n_external_definition ::= c_asm 
            {
              NesCExternalDefinition RESULT =null;
		ASMCall a = (ASMCall)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = a; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_external_definition",179, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
