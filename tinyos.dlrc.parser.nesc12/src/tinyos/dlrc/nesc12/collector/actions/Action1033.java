...
public final class Action1033 implements ParserAction{
 ...
 // c_expression_statement ::= c_semicolon 
		...
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new EmptyStatement( s ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_expression_statement",127, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
