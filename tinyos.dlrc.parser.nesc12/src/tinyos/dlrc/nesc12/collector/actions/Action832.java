...
public final class Action832 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM error c_curly_open error c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( parser.errorNode( "enum declaration", "identifier and/or constant list" ), null, parser.errorNode( "enum declaration", "enum constant list" ) ); 			RESULT = declaration; 			declaration.setRanges( rl, rr ); 
