...
public final class Action1076 implements ParserAction{
 ...
 // c_translation_unit ::= c_external_declaration 
		...
		ExternalDeclaration i = (ExternalDeclaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new TranslationUnit( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_translation_unit",135, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
