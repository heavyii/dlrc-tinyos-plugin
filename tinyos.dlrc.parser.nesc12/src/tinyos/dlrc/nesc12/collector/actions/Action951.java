...
public final class Action951 implements ParserAction{
 ...
 // c_all_identifier_list ::= c_all_identifier_list P_COMMA error 
            {
              IdentifierList RESULT =null;
		IdentifierList s = (IdentifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = s; s.addError( parser.errorNode( "identifier list", "identifier" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_all_identifier_list",111, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
