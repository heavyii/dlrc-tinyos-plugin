...
public final class Action771 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union c_curly_open c_struct_declaration_list c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 DataObjectDeclaration result = new DataObjectDeclaration( s, null, null, d );	RESULT = result; result.setRight( rr.getRight() ); 
