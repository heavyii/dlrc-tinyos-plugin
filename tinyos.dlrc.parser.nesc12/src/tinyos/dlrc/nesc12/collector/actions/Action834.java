...
public final class Action834 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM c_all_identifier n_attributes c_curly_open c_enumerator_list c_curly_close 
            {
