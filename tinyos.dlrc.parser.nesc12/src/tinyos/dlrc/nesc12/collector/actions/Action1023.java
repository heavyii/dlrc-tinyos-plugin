...
public final class Action1023 implements ParserAction{
 ...
 // c_asm_args ::= c_round_open c_asm_args_list c_round_close 
            {
              ASMArgumentsList RESULT =null;
		ASMArgumentsList l = (ASMArgumentsList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = l; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_args",27, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
