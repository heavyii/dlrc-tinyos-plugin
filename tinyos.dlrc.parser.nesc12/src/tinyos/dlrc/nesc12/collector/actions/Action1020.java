...
public final class Action1020 implements ParserAction{
 ...
 // c_asm_no_semicolon ::= K_ASM c_asm_args 
            {
              ASMCall RESULT =null;
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		ASMArgumentsList a = (ASMArgumentsList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ASMCall result = new ASMCall( false, a );
			result.setLeft( k.getLeft() );
			RESULT = result; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_no_semicolon",26, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
