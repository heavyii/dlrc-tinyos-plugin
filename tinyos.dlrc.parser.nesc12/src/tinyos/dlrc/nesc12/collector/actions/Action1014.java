...
public final class Action1014 implements ParserAction{
 ...
 // c_block_item_list ::= c_block_item 
		...
		Statement b = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new CompoundStatement( b ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_block_item_list",125, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
