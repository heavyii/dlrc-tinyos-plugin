...
public final class Action954 implements ParserAction{
 ...
 // c_identifier_list ::= c_identifier_list P_COMMA error 
            {
		...
		IdentifierList s = (IdentifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = s; s.addError( parser.errorNode( "identifier list", "identifier" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_identifier_list",110, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
