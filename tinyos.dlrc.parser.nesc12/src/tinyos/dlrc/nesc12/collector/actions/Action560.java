...
public final class Action560 implements ParserAction{
 ...
 // c_postfix_expression ::= c_postfix_expression P_DECREMENT 
            {
              Expression RESULT =null;
		Expression p = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token d = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new PostfixExpression( p, new PostfixOperator( d, PostfixOperator.Operator.DECREMENT )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_postfix_expression",32, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
