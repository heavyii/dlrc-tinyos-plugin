...
public final class Action26 implements ParserAction{
 ...
 // c_round_close_token ::= P_ROUND_CLOSE 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	parser.scopes().pop();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_round_close_token",17, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
