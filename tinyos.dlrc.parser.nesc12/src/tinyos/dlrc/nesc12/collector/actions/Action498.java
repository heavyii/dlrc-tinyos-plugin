...
public final class Action498 implements ParserAction{
 ...
 // n_uses_or_provides_list ::= n_uses_or_provides 
            {
              AccessList RESULT =null;
		ASTNode i = (ASTNode)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AccessList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_uses_or_provides_list",163, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
