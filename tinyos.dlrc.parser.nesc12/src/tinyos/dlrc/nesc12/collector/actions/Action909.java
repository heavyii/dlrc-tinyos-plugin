...
public final class Action909 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_round_open error c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ParenthesizedDeclarator result = new ParenthesizedDeclarator( parser.errorNode( "parenthesized declarator", "declarator", rl.getRight(), rr.getLeft() ) ); 			RESULT = result; 			result.setRanges( rl, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_direct_declarator_no_hidden_typedef_name",103, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
