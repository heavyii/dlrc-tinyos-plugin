...
public final class Action721 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_tn_nosc_norg ::= c_typedef_name 
            {
              DeclarationSpecifierList RESULT =null;
		TypedefName t = (TypedefName)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationSpecifierList( t ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_tn_nosc_norg",75, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
