...
public final class Action921 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name c_round_open error c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 FunctionDeclarator result = new FunctionDeclarator( d, parser.errorNode( "function declarator", "parameter type list" ) ); 			RESULT = result;  			result.setRight( rr.getRight() ); 
