...
public final class Action570 implements ParserAction{
 ...
 // n_call_kind ::= NK_SIGNAL 
            {
              CallKind RESULT =null;
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new CallKind( CallKind.Call.SIGNAL, k ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_call_kind",197, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
