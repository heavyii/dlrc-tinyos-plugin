...
public final class Action331 implements ParserAction{
 ...
 // n_configuration ::= NK_GENERIC NK_CONFIGURATION c_identifier n_uses_or_provides_block 
            {
		...
		AccessList u = (AccessList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(true,i,null,null,u,parser.missing( "configuration", "implementation", u.getRange().getRight())); 			RESULT.setLeft( rl.getLeft() ); 
