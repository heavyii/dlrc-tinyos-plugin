...
public final class Action962 implements ParserAction{
 ...
 // c_direct_abstract_declarator ::= c_round_open n_attributes c_abstract_declarator c_round_close 
            {
              AbstractDeclarator RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		AttributeList t = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		AbstractDeclarator a = (AbstractDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
