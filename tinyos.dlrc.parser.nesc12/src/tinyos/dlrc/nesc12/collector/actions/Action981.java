...
public final class Action981 implements ParserAction{
 ...
 // c_initializer_list ::= c_designation c_initializer 
            {
		...
		Initializer i = (Initializer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitializerList( new DesignationInitializer( d, i )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_initializer_list",117, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
