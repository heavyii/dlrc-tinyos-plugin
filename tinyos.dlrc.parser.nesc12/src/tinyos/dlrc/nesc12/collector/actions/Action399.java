...
public final class Action399 implements ParserAction{
 ...
 // n_configuration_declaration ::= n_datadef 
            {
              ConfigurationDeclaration RESULT =null;
		Datadef d = (Datadef)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
