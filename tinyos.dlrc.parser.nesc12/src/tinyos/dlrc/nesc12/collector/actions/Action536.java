...
public final class Action536 implements ParserAction{
 ...
 // n_generic_type ::= c_type_name 
            {
              TypeName RESULT =null;
		TypeName t = (TypeName)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = t; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_generic_type",173, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
