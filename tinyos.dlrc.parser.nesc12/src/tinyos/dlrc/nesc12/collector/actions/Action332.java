...
public final class Action332 implements ParserAction{
 ...
 // n_configuration ::= NK_GENERIC NK_CONFIGURATION c_identifier n_configuration_implementation 
            {
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(true,i,null,null,parser.missing( "configuration", "provides/uses block", i.getRange().getRight()),c); 			RESULT.setLeft( rl.getLeft() ); 
