...
public final class Action703 implements ParserAction{
 ...
 // c_declaration_specifiers_tp_notn_nosc_norg ::= c_type_specifier_notn 
            {
		...
		TypeSpecifier t = (TypeSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationSpecifierList( t ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_tp_notn_nosc_norg",71, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
