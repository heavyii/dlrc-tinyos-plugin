...
public final class Action904 implements ParserAction{
 ...
 // c_direct_declarator_typedef_name ::= c_direct_declarator_typedef_name n_interface_parameters c_round_open c_round_close 
            {
