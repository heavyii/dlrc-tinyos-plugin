...
public final class Action794 implements ParserAction{
 ...
 // c_struct_or_union ::= NK_NX_STRUCT 
            {
              DataObjectSpecifier RESULT =null;
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DataObjectSpecifier( k, DataObjectSpecifier.Specifier.NX_STRUCT ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_or_union",90, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
