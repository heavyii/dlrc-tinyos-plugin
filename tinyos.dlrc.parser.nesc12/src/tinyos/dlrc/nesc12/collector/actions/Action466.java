...
public final class Action466 implements ParserAction{
 ...
 // n_parameters ::= P_RECT_OPEN P_RECT_CLOSE 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierParameterList();
			...
			RESULT.addError( parser.missing( "parameter list", "parameter", lr.getLeft(), rr.getRight() ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameters",174, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
