...
public final class Action987 implements ParserAction{
 ...
 // c_designation ::= c_designator_list P_ASSIGN 
            {
              DesignatorList RESULT =null;
		DesignatorList d = (DesignatorList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_designation",118, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
