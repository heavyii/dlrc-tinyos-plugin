...
public final class Action1013 implements ParserAction{
 ...
 // c_compound_statement_recycle ::= c_curly_open_recycle c_until_incl_close_curly 
            {
              CompoundStatement RESULT =null;

              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_compound_statement_recycle",123, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
