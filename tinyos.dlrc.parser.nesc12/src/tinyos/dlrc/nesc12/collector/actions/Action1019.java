...
public final class Action1019 implements ParserAction{
 ...
 // c_asm ::= c_asm_no_semicolon c_semicolon 
            {
              ASMCall RESULT =null;
		ASMCall a = (ASMCall)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token r = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = a; a.setRight( r.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm",25, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
