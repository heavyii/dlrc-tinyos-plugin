...
public final class Action1058 implements ParserAction{
 ...
 // c_iteration_for_update ::= c_iteration_for_header c_round_close 
            {
              ForStatement RESULT =null;
		ForStatement h = (ForStatement)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rc = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; h.setField( ForStatement.UPDATE, parser.missing( "for statement", "expression", rc.getLeft() )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_for_update",131, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
