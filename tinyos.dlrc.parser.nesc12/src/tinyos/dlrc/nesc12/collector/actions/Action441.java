...
public final class Action441 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_all_identifier n_attributes_no_init error 
            {
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new BinaryComponent( i, a, parser.errorNode( "binary component", "provides/uses block") ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( a.getRange().getRight() ); 
