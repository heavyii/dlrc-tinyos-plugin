...
public final class Action308 implements ParserAction{
 ...
 // n_template_parameters ::= n_template_parameters P_COMMA n_template_parameter 
            {
              TemplateParameterList RESULT =null;
		TemplateParameterList s = (TemplateParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		TemplateParameter i = (TemplateParameter)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = s.add( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_template_parameters",160, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
