...
public final class Action955 implements ParserAction{
 ...
 // c_type_name ::= c_declaration_specifiers 
		...
		DeclarationSpecifierList s = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new TypeName( s, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_type_name",112, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
