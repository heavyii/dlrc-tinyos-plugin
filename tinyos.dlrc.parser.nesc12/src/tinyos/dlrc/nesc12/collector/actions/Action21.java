...
public final class Action21 implements ParserAction{
 ...
 // c_curly_close_token ::= P_CURLY_CLOSE 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	parser.scopes().pop();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_curly_close_token",13, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
