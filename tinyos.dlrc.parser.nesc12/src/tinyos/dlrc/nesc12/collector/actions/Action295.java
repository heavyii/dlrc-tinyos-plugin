...
public final class Action295 implements ParserAction{
 ...
 // n_module_head_attributes ::= n_module_head n_component_parameters 
            {
              Module RESULT =null;
		Module h = (Module)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		TemplateParameterList p = (TemplateParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h;
			h.setParameters( p ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_head_attributes",156, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
