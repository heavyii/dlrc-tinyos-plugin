...
public final class Action285 implements ParserAction{
 ...
 // n_interface_parameter_list ::= n_interface_parameter 
            {
		...
		InterfaceParameter i = (InterfaceParameter)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InterfaceParameterList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_parameter_list",144, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
