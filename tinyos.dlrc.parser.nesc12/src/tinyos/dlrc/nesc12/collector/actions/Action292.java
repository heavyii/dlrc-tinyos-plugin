...
public final class Action292 implements ParserAction{
 ...
 // n_module_uses_or_provides ::= n_module_head_attributes n_uses_or_provides_block 
            {
              Module RESULT =null;
		...
		AccessList u = (AccessList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h;
			h.setConnections( u ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_uses_or_provides",155, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
