...
public final class Action1022 implements ParserAction{
 ...
 // c_asm_args ::= c_round_open c_round_close 
            {
              ASMArgumentsList RESULT =null;
		 RESULT = new ASMArgumentsList(); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_args",27, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
