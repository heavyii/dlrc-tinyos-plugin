...
public final class Action741 implements ParserAction{
 ...
 // c_extended_type_qualifier_list ::= c_extended_type_qualifier_list c_declaration_specifier_notp_notn_nosc_norg 
            {
		...
		DeclaratorSpecifier e = (DeclaratorSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = t.add( e ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_extended_type_qualifier_list",81, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
