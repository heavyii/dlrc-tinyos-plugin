...
public final class Action449 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT n_attributes_no_init error 
            {
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new BinaryComponent( parser.missing( "binary component", "identifier", rl.getRight() ), a, parser.errorNode( "binary component", "provides/uses block") ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( a.getRange().getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_binary_component",194, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
