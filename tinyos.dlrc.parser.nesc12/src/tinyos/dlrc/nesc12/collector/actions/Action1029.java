...
public final class Action1029 implements ParserAction{
 ...
 // c_asm_arg_list ::= c_asm_arg_list P_COMMA c_asm_arg 
            {
              ASMArgumentList RESULT =null;
		ASMArgumentList l = (ASMArgumentList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		ASMArgument a = (ASMArgument)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = l; l.add( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_arg_list",29, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
