...
public final class Action440 implements ParserAction{
 ...
 // n_generic_argument ::= n_generic_type 
            {
              GenericArgument RESULT =null;
		TypeName g = (TypeName)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = g; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_generic_argument",193, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
