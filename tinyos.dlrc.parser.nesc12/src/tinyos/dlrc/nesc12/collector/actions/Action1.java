...
public final class Action1 implements ParserAction{
 ...
 // c_identifier ::= IDENTIFIER 
		...
		Token i = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Identifier( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_identifier",0, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
