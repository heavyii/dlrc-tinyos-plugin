...
public final class Action383 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION error n_component_parameters n_attributes_no_init n_uses_or_provides_block 
            {
		...
		AccessList u = (AccessList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,parser.errorNode( "configuration", "identifier" ),p,a,u,parser.missing( "configuration", "implementation", u.getRange().getRight())); 			RESULT.setLeft( k.getLeft() ); 
