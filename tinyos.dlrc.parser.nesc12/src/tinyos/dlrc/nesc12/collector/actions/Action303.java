...
public final class Action303 implements ParserAction{
 ...
 // n_module_generic ::= NK_MODULE 
            {
              Module RESULT =null;
		Token lr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Module( false, null, null, null, null, null ); 
			RESULT.setLeft( lr.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_generic",158, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
