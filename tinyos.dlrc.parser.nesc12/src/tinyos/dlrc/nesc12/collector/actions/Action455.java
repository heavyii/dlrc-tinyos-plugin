...
public final class Action455 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_curly_open n_uses_or_provides_list c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new BinaryComponent( parser.missing( "binary component", "identifier", rl.getRight() ), null, u ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
