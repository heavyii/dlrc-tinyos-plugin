...
public final class Action268 implements ParserAction{
 ...
 // n_includes ::= NK_INCLUDES c_semicolon 
            {
		...
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Includes( k, null ); RESULT.setRight( s.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_includes",139, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
