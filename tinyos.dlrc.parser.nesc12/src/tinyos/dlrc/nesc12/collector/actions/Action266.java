...
public final class Action266 implements ParserAction{
 ...
 // c_until_incl_close_curly ::= c_all_no_curly c_curly_close 
            {
              Object RESULT =null;

              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_until_incl_close_curly",199, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
