...
public final class Action777 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union error c_curly_open c_struct_declaration_list c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 DataObjectDeclaration result = new DataObjectDeclaration( s, parser.errorNode( "data object declaration", "identifier or field declarations" ), null, d );	RESULT = result; result.setRight( rr.getRight() ); 
