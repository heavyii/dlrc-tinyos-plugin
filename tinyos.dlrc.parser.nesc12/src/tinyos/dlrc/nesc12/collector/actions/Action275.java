...
public final class Action275 implements ParserAction{
 ...
 // n_interface_head_parameters ::= n_interface_head n_interface_parameters n_attributes_no_init 
            {
              Interface RESULT =null;
		Interface h = (Interface)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; 
			h.setParameters( p );
			h.setAttributes( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_head_parameters",141, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
