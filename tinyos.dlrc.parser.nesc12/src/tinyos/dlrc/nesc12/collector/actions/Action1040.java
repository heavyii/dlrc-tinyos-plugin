...
public final class Action1040 implements ParserAction{
 ...
 // c_selection_statement ::= K_IF error c_statement 
            {
		...
		Statement t = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 IfStatement result = new IfStatement( parser.errorNode( "if statement", "expression" ), t, null ); RESULT = result; result.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_selection_statement",128, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
