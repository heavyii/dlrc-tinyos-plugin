...
public final class Action474 implements ParserAction{
 ...
 // n_param ::= c_declaration_specifiers 
            {
		...
		DeclarationSpecifierList s = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierParameter( s, null, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_param",176, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
