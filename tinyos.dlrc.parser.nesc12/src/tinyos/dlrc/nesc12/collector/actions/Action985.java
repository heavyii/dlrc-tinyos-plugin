...
public final class Action985 implements ParserAction{
 ...
 // c_initializer_list ::= c_initializer_list P_COMMA c_designation c_initializer 
            {
              InitializerList RESULT =null;
		InitializerList l = (InitializerList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		DesignatorList d = (DesignatorList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Initializer i = (Initializer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = l.add( new DesignationInitializer( d, i ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_initializer_list",117, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
