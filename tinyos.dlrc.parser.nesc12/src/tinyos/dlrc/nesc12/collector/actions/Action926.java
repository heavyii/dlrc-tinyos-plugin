...
public final class Action926 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name n_interface_parameters c_round_open n_params c_round_close 
            {
