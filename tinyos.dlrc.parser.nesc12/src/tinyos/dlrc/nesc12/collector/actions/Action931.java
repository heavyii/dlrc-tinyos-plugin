...
public final class Action931 implements ParserAction{
 ...
 // c_type_qualifier_and_static_list ::= K_STATIC 
            {
		...
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclarationSpecifierList( new StorageClass( k, StorageClass.Storage.STATIC )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_type_qualifier_and_static_list",83, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
