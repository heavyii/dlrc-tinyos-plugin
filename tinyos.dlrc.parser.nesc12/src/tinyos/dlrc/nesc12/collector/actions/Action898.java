...
public final class Action898 implements ParserAction{
 ...
 // c_direct_declarator_typedef_name ::= c_direct_declarator_typedef_name c_round_open c_identifier_list c_round_close 
            {
