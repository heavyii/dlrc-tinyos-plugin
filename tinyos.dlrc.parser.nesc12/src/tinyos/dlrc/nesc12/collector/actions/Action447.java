...
public final class Action447 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_all_identifier c_curly_open n_uses_or_provides_list c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new BinaryComponent( i, null, u ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
