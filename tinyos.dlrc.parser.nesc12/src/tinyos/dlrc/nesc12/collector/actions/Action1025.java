...
public final class Action1025 implements ParserAction{
 ...
 // c_asm_args_list ::= c_asm_args_list P_COLON 
            {
		...
		ASMArgumentsList l = (ASMArgumentsList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = l;
			l.add( null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_args_list",28, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
