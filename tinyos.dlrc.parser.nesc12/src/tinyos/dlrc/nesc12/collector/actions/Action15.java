...
public final class Action15 implements ParserAction{
 ...
 // c_semicolon_token ::= P_SEMICOLON 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 parser.scopes().wipe();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_semicolon_token",7, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
