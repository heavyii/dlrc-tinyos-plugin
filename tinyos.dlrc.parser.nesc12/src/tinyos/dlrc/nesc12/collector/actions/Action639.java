...
public final class Action639 implements ParserAction{
 ...
 // c_conditional_expression ::= c_conditional_expression_middle 
            {
              Expression RESULT =null;
		ConditionalExpression h = (ConditionalExpression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; h.setField( ConditionalExpression.ELSE_VALUE, parser.missing( "conditional expression", "expression", h.getRange().getRight() ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_conditional_expression",54, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
