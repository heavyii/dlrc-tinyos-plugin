...
public final class Action1032 implements ParserAction{
 ...
 // c_asm_arg ::= c_string_literal c_round_open c_expression c_round_close 
            {
              ASMArgument RESULT =null;
		StringLiteralList l = (StringLiteralList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		...
		Token rc = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ASMArgument( l, e );
			RESULT.setRight( rc.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_arg",30, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
