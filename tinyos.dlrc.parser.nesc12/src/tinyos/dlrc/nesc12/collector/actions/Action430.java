...
public final class Action430 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW c_all_identifier error 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new NewComponent( i, parser.errorNode( "new component", "generic argument list" ), null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( i.getRange().getRight() ); 
