...
public final class Action445 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_all_identifier error 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new BinaryComponent( i, null, parser.errorNode( "binary component", "provides/uses block") ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( i.getRange().getRight() ); 
