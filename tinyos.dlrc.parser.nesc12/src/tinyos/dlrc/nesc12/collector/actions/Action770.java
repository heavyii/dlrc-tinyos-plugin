...
public final class Action770 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union c_all_identifier c_curly_open error c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 DataObjectDeclaration result = new DataObjectDeclaration( s, i, null, parser.errorNode( "data object declaration", "field declarations" ) );	RESULT = result; result.setRight( rr.getRight() ); 
