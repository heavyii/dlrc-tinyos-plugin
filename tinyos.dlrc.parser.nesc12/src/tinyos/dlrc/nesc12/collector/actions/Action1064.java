...
public final class Action1064 implements ParserAction{
 ...
 // c_iteration_for_header ::= K_FOR c_round_open c_declaration 
            {
		...
		Declaration d = (Declaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ForStatement result = new ForStatement( d, null, null, null );
			...
			result.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_for_header",133, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
