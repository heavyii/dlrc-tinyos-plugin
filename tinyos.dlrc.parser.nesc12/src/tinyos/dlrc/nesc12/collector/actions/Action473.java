...
public final class Action473 implements ParserAction{
 ...
 // n_param ::= c_declaration_specifiers c_abstract_declarator 
            {
		...
		AbstractDeclarator d = (AbstractDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierParameter( s, d, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_param",176, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
