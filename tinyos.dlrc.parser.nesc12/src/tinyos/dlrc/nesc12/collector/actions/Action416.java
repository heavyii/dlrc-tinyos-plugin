...
public final class Action416 implements ParserAction{
 ...
 // n_component_uses ::= NK_COMPONENTS error 
            {
		...
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ComponentList(); RESULT.addError( parser.errorNode( "components", "list of components" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_component_uses",188, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
