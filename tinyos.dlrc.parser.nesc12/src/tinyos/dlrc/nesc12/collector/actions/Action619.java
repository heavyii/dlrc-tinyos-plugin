...
public final class Action619 implements ParserAction{
 ...
 // c_equality_expression ::= c_equality_expression c_equality_operator error 
            {
		...
		ArithmeticOperator p = (ArithmeticOperator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ArithmeticExpression( e, p, parser.errorNode( "arithmetic expression", "right hand side expression" ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_equality_expression",47, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
