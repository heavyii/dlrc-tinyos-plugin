...
public final class Action9 implements ParserAction{
 ...
 // c_string_literal ::= c_string_literal STRING 
            {
              StringLiteralList RESULT =null;
		StringLiteralList l = (StringLiteralList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = l.add( new StringLiteral( s ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_string_literal",5, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
