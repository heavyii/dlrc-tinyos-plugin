...
public final class Action599 implements ParserAction{
 ...
 // c_multiplicative_operator ::= P_PERCENT 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticOperator( p, ArithmeticOperator.Operator.MOD ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_multiplicative_operator",40, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
