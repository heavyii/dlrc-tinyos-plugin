...
public final class Action1085 implements ParserAction{
 ...
 // c_function_definition ::= c_declaration_specifiers c_declarator_typedef_name c_declaration_list c_compound_statement_recycle 
            {
              FunctionDefinition RESULT =null;
		int sleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		DeclarationSpecifierList s = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		...
		CompoundStatement cs = (CompoundStatement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new FunctionDefinition( s, d, l, cs ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_function_definition",137, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
