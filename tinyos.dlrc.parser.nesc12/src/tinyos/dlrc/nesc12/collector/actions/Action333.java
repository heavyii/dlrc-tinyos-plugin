...
public final class Action333 implements ParserAction{
 ...
 // n_configuration ::= NK_GENERIC NK_CONFIGURATION c_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(true,i,null,null,parser.missing( "configuration", "provides/uses block", i.getRange().getRight()),parser.missing( "configuration", "implementation", i.getRange().getRight())); 			RESULT.setLeft( rl.getLeft() ); 
