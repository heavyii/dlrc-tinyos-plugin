...
public final class Action817 implements ParserAction{
 ...
 // c_struct_declarator ::= P_COLON c_constant_expression 
            {
		...
		Expression c = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DataObjectFieldDeclarator( (Declaration)null, c ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_declarator",94, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
