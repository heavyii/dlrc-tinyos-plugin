...
public final class Action679 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_tn ::= c_declaration_specifiers_notp_tn_nosc_norg 
            {
		...
		DeclarationSpecifierList d = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_tn",67, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
