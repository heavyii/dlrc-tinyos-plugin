...
public final class Action840 implements ParserAction{
 ...
 // c_enum_specifier ::= K_ENUM error n_attributes c_curly_open c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 EnumDeclaration declaration = new EnumDeclaration( parser.errorNode( "enum declaration", "identifier" ), a, new EnumConstantList() ); 			RESULT = declaration; 			declaration.setRanges( rl, rr ); 
