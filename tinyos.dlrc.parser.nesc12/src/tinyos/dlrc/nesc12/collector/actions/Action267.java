...
public final class Action267 implements ParserAction{
 ...
 // c_until_incl_close_curly ::= c_until_incl_open_curly c_until_incl_close_curly c_until_incl_close_curly 
            {
              Object RESULT =null;

              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_until_incl_close_curly",199, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
