...
public final class Action289 implements ParserAction{
 ...
 // n_interface_parameter ::= c_all_identifier n_attributes_no_init 
            {
              InterfaceParameter RESULT =null;
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new InterfaceParameter( i, a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_parameter",145, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
