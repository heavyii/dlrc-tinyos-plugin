...
public final class Action873 implements ParserAction{
 ...
 // c_direct_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name P_RECT_OPEN c_array_declarator_qualifiers c_assignment_expression P_RECT_CLOSE 
            {
