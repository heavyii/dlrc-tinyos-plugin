 ...
 // c_type_qualifier ::= K_VOLATILE 
		...
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new TypeQualifier( k, TypeQualifier.Qualifier.VOLATILE ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_type_qualifier",98, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
