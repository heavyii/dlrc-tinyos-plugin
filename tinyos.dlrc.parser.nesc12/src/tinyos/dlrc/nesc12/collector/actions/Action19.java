...
public final class Action19 implements ParserAction{
 ...
 // c_curly_open_token_recycle ::= P_CURLY_OPEN 
            {
              Token RESULT =null;
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			parser.scopes().recycle();
			RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_curly_open_token_recycle",9, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
