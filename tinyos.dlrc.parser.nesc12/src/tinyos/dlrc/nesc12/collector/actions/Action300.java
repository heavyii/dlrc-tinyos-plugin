 ...
 // n_module_head ::= n_module_generic 
		...
		Module h = (Module)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; h.setField( Module.NAME, parser.missing( "module", "identifier", h.getRange().getRight() ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_head",157, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
