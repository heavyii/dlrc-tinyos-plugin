...
public final class Action1034 implements ParserAction{
 ...
 // c_expression_statement ::= c_expression c_semicolon 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ExpressionStatement result = new ExpressionStatement( e );
			...
			result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_expression_statement",127, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
