...
public final class Action862 implements ParserAction{
 ...
 // c_declarator_no_hidden_typedef_name ::= c_pointer c_direct_declarator_no_hidden_typedef_name 
            {
              Declarator RESULT =null;
		Pointer p = (Pointer)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
