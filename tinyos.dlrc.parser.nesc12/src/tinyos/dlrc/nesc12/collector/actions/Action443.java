...
public final class Action443 implements ParserAction{
 ...
 // n_binary_component ::= NK_COMPONENT c_all_identifier n_attributes_no_init c_curly_open n_uses_or_provides_list c_curly_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new BinaryComponent( i, a, u ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
