 ...
 // c_additive_operator ::= P_MINUS 
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticOperator( p, ArithmeticOperator.Operator.SUB ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_additive_operator",42, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
