...
public final class Action305 implements ParserAction{
 ...
 // n_component_parameters ::= c_round_open n_template_parameters c_round_close_remember 
            {
              TemplateParameterList RESULT =null;
		TemplateParameterList t = (TemplateParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = t; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_component_parameters",159, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
