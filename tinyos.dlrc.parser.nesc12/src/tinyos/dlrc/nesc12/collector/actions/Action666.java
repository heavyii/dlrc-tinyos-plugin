...
public final class Action666 implements ParserAction{
 ...
 // c_declaration ::= c_declaration_specifiers c_semicolon 
		...
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Declaration( d, new InitDeclaratorList() ); RESULT.setRight( s.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration",61, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
