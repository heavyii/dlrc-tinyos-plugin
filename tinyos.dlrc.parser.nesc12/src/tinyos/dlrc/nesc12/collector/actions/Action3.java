...
public final class Action3 implements ParserAction{
 ...
 // c_typedef_name_identifier ::= TYPEDEF 
            {
              Identifier RESULT =null;
		Token t = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Identifier( t ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_typedef_name_identifier",2, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
