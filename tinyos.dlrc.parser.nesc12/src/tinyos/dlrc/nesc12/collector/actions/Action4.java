...
public final class Action4 implements ParserAction{
 ...
 // c_enumeration_constant ::= ENUMERATION_CONSTANT 
            {
		...
		Token c = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new EnumerationConstant( new Identifier( c )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_enumeration_constant",3, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
