...
public final class Action624 implements ParserAction{
 ...
 // c_and_expression ::= c_and_expression P_AMP error 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ArithmeticExpression( a, new ArithmeticOperator( p, ArithmeticOperator.Operator.BIT_AND ), parser.errorNode( "arithmetic expression", "right hand side expression" ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_and_expression",49, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
