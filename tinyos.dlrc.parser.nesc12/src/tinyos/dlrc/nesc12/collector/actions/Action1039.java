...
public final class Action1039 implements ParserAction{
 ...
 // c_selection_statement ::= K_IF c_round_open error c_round_close c_statement K_ELSE c_statement 
            {
		...
		Statement f = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 IfStatement result = new IfStatement( parser.errorNode( "if statement", "expression" ), t, f ); RESULT = result; result.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_selection_statement",128, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
