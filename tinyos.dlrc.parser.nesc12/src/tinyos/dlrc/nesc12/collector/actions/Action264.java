...
public final class Action264 implements ParserAction{
 ...
 // c_until_incl_open_curly ::= c_all_no_curly c_curly_open 
            {
              Object RESULT =null;

              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_until_incl_open_curly",198, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
