...
public final class Action644 implements ParserAction{
 ...
 // c_conditional_expression_head ::= P_QUESTION 
            {
		...
		Token q = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	RESULT = new ConditionalExpression( parser.missing( "conditional expression", "expression", q.getLeft() ), null, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_conditional_expression_head",56, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
