...
public final class Action521 implements ParserAction{
 ...
 // n_parameterised_interface ::= n_interface_ref n_parameters error c_semicolon 
            {
              ASTNode RESULT =null;
		InterfaceReference i = (InterfaceReference)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		IdentifierParameterList p = (IdentifierParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ParameterizedInterface result = new ParameterizedInterface( i, p, parser.errorNode( "interface", "attribute list" ) );
			...
			result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterised_interface",169, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
