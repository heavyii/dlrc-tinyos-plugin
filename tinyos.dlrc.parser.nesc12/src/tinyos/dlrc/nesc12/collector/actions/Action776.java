...
public final class Action776 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union c_all_identifier n_attributes_no_init c_curly_open error c_curly_close 
            {
              TypeSpecifier RESULT =null;
		DataObjectSpecifier s = (DataObjectSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 DataObjectDeclaration result = new DataObjectDeclaration( s, i, a, parser.errorNode( "data object declaration", "field declarations" ) );	RESULT = result; result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_or_union_specifier",89, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
