...
public final class Action661 implements ParserAction{
 ...
 // c_expression ::= c_assignment_expression error 
            {
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 if( !(e instanceof ExpressionList) ){
			...
			RESULT = list;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_expression",59, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
