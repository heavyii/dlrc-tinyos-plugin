...
public final class Action711 implements ParserAction{
 ...
 // c_declaration_specifiers_notp_tn_sc_norg ::= c_declaration_specifiers_notp_notn_sc_norg c_typedef_name 
            {
		...
		TypedefName e = (TypedefName)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d.add( e ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_specifiers_notp_tn_sc_norg",73, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
