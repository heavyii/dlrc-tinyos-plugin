...
public final class Action489 implements ParserAction{
 ...
 // n_attribute_initializer_list ::= c_round_open error P_COMMA c_round_close 
            {
              InitializerList RESULT =null;
		int roleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		Token ro = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		int rcright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Token rc = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitializerList();
			RESULT.setRanges( roleft, rcright );
			RESULT.addError( parser.errorNode( "attribute initializer", "expression list", ro.getRight(), rc.getLeft() ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_attribute_initializer_list",150, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
