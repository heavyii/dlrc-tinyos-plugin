...
public final class Action615 implements ParserAction{
 ...
 // c_relational_operator ::= P_SMALLER_EQ 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticOperator( p, ArithmeticOperator.Operator.SMALLER_EQ ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_relational_operator",46, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
