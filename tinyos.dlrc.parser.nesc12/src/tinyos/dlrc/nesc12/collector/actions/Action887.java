...
public final class Action887 implements ParserAction{
 ...
 // c_direct_declarator_typedef_name ::= c_identifier 
            {
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_direct_declarator_typedef_name",102, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
