...
public final class Action1089 implements ParserAction{
 ...
 // c_declaration_list ::= c_declaration_list error 
            {
              DeclarationList RESULT =null;
		DeclarationList s = (DeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = s; s.addError( parser.errorNode( "declaration list", "declaration" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declaration_list",138, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
