...
public final class Action293 implements ParserAction{
 ...
 // n_module_uses_or_provides ::= n_module_head_attributes 
            {
              Module RESULT =null;
		Module h = (Module)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h;
			h.setField( Module.CONNECTIONS, parser.missing( "module", "uses/provides block", h.getRange().getRight() ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_uses_or_provides",155, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
