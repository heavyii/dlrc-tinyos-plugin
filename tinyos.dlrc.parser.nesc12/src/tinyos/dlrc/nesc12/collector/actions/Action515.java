...
public final class Action515 implements ParserAction{
 ...
 // n_parameterised_interfaces ::= n_parameterised_interfaces error 
            {
              ParameterizedInterfaceList RESULT =null;
		ParameterizedInterfaceList s = (ParameterizedInterfaceList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = s; s.addError( parser.errorNode( "interface list", "interface" )); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterised_interfaces",168, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
