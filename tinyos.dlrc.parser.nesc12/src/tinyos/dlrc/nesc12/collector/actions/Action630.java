...
public final class Action630 implements ParserAction{
 ...
 // c_inclusive_or_expression ::= c_inclusive_or_expression P_LINE error 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ArithmeticExpression( i, new ArithmeticOperator( p, ArithmeticOperator.Operator.BIT_OR ), parser.errorNode( "arithmetic expression", "right hand side expression" ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_inclusive_or_expression",51, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
