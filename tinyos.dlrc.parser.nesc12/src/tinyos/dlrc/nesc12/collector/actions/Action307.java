...
public final class Action307 implements ParserAction{
 ...
 // n_template_parameters ::= n_template_parameter 
            {
		...
		TemplateParameter i = (TemplateParameter)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new TemplateParameterList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_template_parameters",160, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
