...
public final class Action1037 implements ParserAction{
 ...
 // c_selection_statement ::= K_IF c_round_open c_expression c_round_close c_statement K_ELSE c_statement 
            {
		...
		Statement f = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 IfStatement result = new IfStatement( e, t, f ); RESULT = result; result.setLeft( rl.getLeft() ); 
