...
public final class Action1078 implements ParserAction{
 ...
 // c_translation_unit ::= c_translation_unit error 
            {
		...
		TranslationUnit s = (TranslationUnit)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = s; s.addError( parser.errorNode( "translation unit", "declaration" )); 
