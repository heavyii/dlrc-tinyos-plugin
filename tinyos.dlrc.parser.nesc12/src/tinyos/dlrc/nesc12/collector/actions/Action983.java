...
public final class Action983 implements ParserAction{
 ...
 // c_initializer_list ::= c_initializer_list P_COMMA c_initializer 
            {
		...
		Initializer i = (Initializer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = l.add( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_initializer_list",117, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
