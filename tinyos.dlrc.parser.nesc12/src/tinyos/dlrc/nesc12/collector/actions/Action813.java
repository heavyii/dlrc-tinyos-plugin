...
public final class Action813 implements ParserAction{
 ...
 // c_struct_declarator_list ::= c_struct_declarator_list P_COMMA error 
            {
		...
		DataObjectFieldDeclaratorList s = (DataObjectFieldDeclaratorList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = s; s.addError( parser.errorNode( "declarator list", "declarator" )); 
