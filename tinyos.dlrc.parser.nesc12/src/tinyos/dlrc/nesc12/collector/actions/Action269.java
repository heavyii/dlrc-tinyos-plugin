...
public final class Action269 implements ParserAction{
 ...
 // n_includes ::= NK_INCLUDES c_all_identifier_list c_semicolon 
            {
              Includes RESULT =null;
		Token k = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		IdentifierList f = (IdentifierList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token s = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Includes( k, f ); RESULT.setRight( s.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_includes",139, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
