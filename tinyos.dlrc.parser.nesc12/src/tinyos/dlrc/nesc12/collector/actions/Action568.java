 ...
 // c_compound_literal_head ::= c_round_open c_round_close 
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new CompoundLiteral( parser.missing( "compound literal", "type name", rl.getLeft(), rr.getRight() ), null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_compound_literal_head",34, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
