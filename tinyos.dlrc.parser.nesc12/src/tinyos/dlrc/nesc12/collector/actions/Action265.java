...
public final class Action265 implements ParserAction{
 ...
 // c_until_incl_close_curly ::= c_curly_close 
            {
              Object RESULT =null;

              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_until_incl_close_curly",199, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
