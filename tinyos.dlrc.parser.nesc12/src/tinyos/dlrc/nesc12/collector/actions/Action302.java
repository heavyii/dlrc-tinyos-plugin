...
public final class Action302 implements ParserAction{
 ...
 // n_module_generic ::= NK_GENERIC NK_MODULE 
            {
              Module RESULT =null;
		Token lr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new Module( true, null, null, null, null, null ); 
			RESULT.setLeft( lr.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_generic",158, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
