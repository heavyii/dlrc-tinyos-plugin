...
public final class Action865 implements ParserAction{
 ...
 // c_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name 
            {
              Declarator RESULT =null;
		Declarator d = (Declarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = d; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_declarator_no_hidden_typedef_name",100, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
