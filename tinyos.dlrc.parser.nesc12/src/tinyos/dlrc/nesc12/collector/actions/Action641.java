...
public final class Action641 implements ParserAction{
 ...
 // c_conditional_expression_middle ::= c_conditional_expression_head P_COLON 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			h.setField( ConditionalExpression.IF_VALUE, parser.missing( "conditional expression", "expression", h.getRange().getRight(), p.getLeft() ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_conditional_expression_middle",55, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
