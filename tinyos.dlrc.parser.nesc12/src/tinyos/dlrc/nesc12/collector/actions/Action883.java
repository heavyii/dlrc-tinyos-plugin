...
public final class Action883 implements ParserAction{
 ...
 // c_direct_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name P_RECT_OPEN c_parameter_type_list P_RECT_CLOSE 
            {
