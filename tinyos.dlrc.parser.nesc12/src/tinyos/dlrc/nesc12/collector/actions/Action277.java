...
public final class Action277 implements ParserAction{
 ...
 // n_interface_head_parameters ::= n_interface_head n_interface_parameters 
            {
              Interface RESULT =null;
		Interface h = (Interface)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		InterfaceParameterList p = (InterfaceParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; 
			h.setParameters( p ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_head_parameters",141, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
