...
public final class Action655 implements ParserAction{
 ...
 // c_assignment_operator ::= P_SHIFT_RIGHT_ASSIGN 
            {
		...
		Token p = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new AssignmentOperator( p, AssignmentOperator.Operator.SHIFT_RIGHT ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_assignment_operator",58, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
