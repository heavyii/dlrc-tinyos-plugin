...
public final class Action903 implements ParserAction{
 ...
 // c_direct_declarator_typedef_name ::= c_direct_declarator_typedef_name P_RECT_OPEN c_parameter_type_list P_RECT_CLOSE 
            {
