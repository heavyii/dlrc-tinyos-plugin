...
public final class Action880 implements ParserAction{
 ...
 // c_direct_declarator_no_typedef_name ::= c_direct_declarator_no_typedef_name c_round_open error c_round_close 
            {
