...
public final class Action662 implements ParserAction{
 ...
 // c_expression ::= c_expression P_COMMA c_assignment_expression 
            {
		...
		Expression a = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 	if( e instanceof ExpressionList ){
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_expression",59, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
