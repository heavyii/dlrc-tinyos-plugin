...
public final class Action406 implements ParserAction{
 ...
 // n_connection ::= n_wire c_semicolon 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Connection( parser.missing( "connection", "left endpoint", w.getRange().getLeft() ), w, parser.missing( "connection", "right endpoint", w.getRange().getRight() ) ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_connection",184, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
