...
public final class Action291 implements ParserAction{
 ...
 // n_module ::= n_module_uses_or_provides n_module_implementation 
            {
              Module RESULT =null;
		Module h = (Module)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		NesCExternalDefinitionList m = (NesCExternalDefinitionList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h;
			h.setImplementation( m ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module",154, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
