...
public final class Action780 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union NP_AT c_all_identifier c_curly_open c_struct_declaration_list c_curly_close 
            {
