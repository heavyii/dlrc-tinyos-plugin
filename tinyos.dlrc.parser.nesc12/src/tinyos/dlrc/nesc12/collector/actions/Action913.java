...
public final class Action913 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name P_RECT_OPEN c_assignment_expression P_RECT_CLOSE 
            {
