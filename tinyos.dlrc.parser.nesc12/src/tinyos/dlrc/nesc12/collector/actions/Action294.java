...
public final class Action294 implements ParserAction{
 ...
 // n_module_head_attributes ::= n_module_head n_component_parameters n_attributes_no_init 
            {
              Module RESULT =null;
		Module h = (Module)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		...
		AttributeList a = (AttributeList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h;
			h.setParameters( p );
			h.setAttributes( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_head_attributes",156, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
