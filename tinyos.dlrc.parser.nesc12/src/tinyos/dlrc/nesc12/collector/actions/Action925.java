...
public final class Action925 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name n_interface_parameters c_round_open c_round_close 
            {
              Declarator RESULT =null;
		Declarator d = (Declarator)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		InterfaceParameterList i = (InterfaceParameterList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 InterfaceDeclarator result = new InterfaceDeclarator( d, i, null ); 			RESULT = result; 			result.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_direct_declarator_no_hidden_typedef_name",103, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
