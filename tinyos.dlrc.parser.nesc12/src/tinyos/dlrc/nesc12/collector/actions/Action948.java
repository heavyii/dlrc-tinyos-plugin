...
public final class Action948 implements ParserAction{
 ...
 // c_parameter_declaration ::= c_declaration_specifiers_nosc c_abstract_declarator 
            {
		...
		AbstractDeclarator a = (AbstractDeclarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterDeclaration( s, a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_parameter_declaration",109, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
