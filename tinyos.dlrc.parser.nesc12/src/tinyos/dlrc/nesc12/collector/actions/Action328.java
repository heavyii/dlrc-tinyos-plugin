...
public final class Action328 implements ParserAction{
 ...
 // n_external_definition ::= K_EXTENSION n_external_definition 
            {
              NesCExternalDefinition RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		NesCExternalDefinition e = (NesCExternalDefinition)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ExtensionExternalDefinition result = new ExtensionExternalDefinition( e );
			RESULT = result; 
			result.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_external_definition",179, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
