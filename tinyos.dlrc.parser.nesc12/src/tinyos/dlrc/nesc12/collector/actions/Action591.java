...
public final class Action591 implements ParserAction{
 ...
 // c_cast_expression ::= c_unary_expression 
            {
              Expression RESULT =null;
		Expression u = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = u; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_cast_expression",38, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
