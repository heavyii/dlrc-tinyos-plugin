...
public final class Action364 implements ParserAction{
 ...
 // n_configuration ::= NK_CONFIGURATION c_identifier n_configuration_implementation 
            {
		...
		ConfigurationDeclarationList c = (ConfigurationDeclarationList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Configuration(false,i,null,null,parser.missing( "configuration", "provides/uses block", i.getRange().getRight()),c); 			RESULT.setLeft( k.getLeft() ); 
