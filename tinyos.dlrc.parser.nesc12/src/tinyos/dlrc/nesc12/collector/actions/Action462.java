...
public final class Action462 implements ParserAction{
 ...
 // n_parameterized_identifier ::= c_all_identifier P_RECT_OPEN c_expression P_RECT_CLOSE 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterizedIdentifier( i, e );
			RESULT.setRight( rr.getRight() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_parameterized_identifier",187, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
