...
public final class Action1050 implements ParserAction{
 ...
 // c_iteration_statement ::= c_iteration_for_update c_statement 
            {
              Statement RESULT =null;
		ForStatement u = (ForStatement)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Statement s = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = u; u.setBody( s ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_iteration_statement",129, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
