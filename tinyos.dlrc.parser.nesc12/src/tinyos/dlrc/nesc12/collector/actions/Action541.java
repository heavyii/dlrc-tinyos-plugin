...
public final class Action541 implements ParserAction{
 ...
 // c_primary_expression ::= c_round_open c_compound_statement c_round_close 
            {
              Expression RESULT =null;
		Token rl = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		CompoundStatement c = (CompoundStatement)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			result.setRanges( rl, rr );
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_primary_expression",31, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
