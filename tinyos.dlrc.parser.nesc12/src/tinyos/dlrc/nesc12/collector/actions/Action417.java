...
public final class Action417 implements ParserAction{
 ...
 // n_component_list ::= n_component_ref 
            {
              ComponentList RESULT =null;
		Component i = (Component)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ComponentList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_component_list",189, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
