...
public final class Action1027 implements ParserAction{
 ...
 // c_asm_args_list ::= c_asm_args_list P_COLON c_asm_arg_list 
		...
		ASMArgumentsList l = (ASMArgumentsList)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		ASMArgumentList a = (ASMArgumentList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = l; l.add( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_args_list",28, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
