...
public final class Action1028 implements ParserAction{
 ...
 // c_asm_arg_list ::= c_asm_arg 
		...
		ASMArgument a = (ASMArgument)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ASMArgumentList( a ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_arg_list",29, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
