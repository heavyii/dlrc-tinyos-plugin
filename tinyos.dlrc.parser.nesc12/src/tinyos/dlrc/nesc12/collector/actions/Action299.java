...
public final class Action299 implements ParserAction{
 ...
 // n_module_head ::= n_module_generic c_all_identifier 
            {
              Module RESULT =null;
		...
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = h; h.setName( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_module_head",157, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
