...
public final class Action920 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name c_round_open c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 FunctionDeclarator result = new FunctionDeclarator( d, null ); 			RESULT = result; 			result.setRight( rr.getRight() ); 
