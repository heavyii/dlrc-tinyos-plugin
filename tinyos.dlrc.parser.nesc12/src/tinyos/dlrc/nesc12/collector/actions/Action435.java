...
public final class Action435 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW c_round_open c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NewComponent( parser.missing( "new component", "identifier", rl.getRight() ), new GenericArgumentList(), null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
