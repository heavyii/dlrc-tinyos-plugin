...
public final class Action912 implements ParserAction{
 ...
 // c_direct_declarator_no_hidden_typedef_name ::= c_direct_declarator_no_hidden_typedef_name P_RECT_OPEN c_array_declarator_qualifiers P_RECT_CLOSE 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayDeclarator result = new ArrayDeclarator( d, t, null ); 			RESULT = result; 			result.setRight( rr.getRight() ); 
