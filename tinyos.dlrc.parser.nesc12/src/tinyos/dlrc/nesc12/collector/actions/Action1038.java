...
public final class Action1038 implements ParserAction{
 ...
 // c_selection_statement ::= K_IF c_round_open error c_round_close c_statement 
            {
		...
		Statement t = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 IfStatement result = new IfStatement( parser.errorNode( "if statement", "expression" ), t, null ); RESULT = result; result.setLeft( rl.getLeft() ); 
