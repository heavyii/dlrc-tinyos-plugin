...
public final class Action7 implements ParserAction{
 ...
 // c_all_identifier ::= ENUMERATION_CONSTANT 
            {
              Identifier RESULT =null;
		Token c = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Identifier( c ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_all_identifier",1, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
