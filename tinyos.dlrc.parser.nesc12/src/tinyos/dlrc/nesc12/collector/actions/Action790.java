...
public final class Action790 implements ParserAction{
 ...
 // c_struct_or_union_specifier ::= c_struct_or_union c_all_identifier 
            {
              TypeSpecifier RESULT =null;
		DataObjectSpecifier s = (DataObjectSpecifier)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		Identifier i = (Identifier)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IncompleteDataObject( s, i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_struct_or_union_specifier",89, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
