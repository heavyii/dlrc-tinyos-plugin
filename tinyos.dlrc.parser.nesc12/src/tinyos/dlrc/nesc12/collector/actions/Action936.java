...
public final class Action936 implements ParserAction{
 ...
 // c_pointer ::= P_STAR c_type_qualifier_list 
            {
              Pointer RESULT =null;
		...
		DeclarationSpecifierList t = (DeclarationSpecifierList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Pointer( t, null ); 
			RESULT.setLeft( rl.getLeft() ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_pointer",105, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
