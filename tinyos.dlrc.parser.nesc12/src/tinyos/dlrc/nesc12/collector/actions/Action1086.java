...
public final class Action1086 implements ParserAction{
 ...
 // c_function_definition ::= c_declaration_specifiers c_declarator_typedef_name c_compound_statement_recycle 
            {
		...
		CompoundStatement c = (CompoundStatement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new FunctionDefinition( s, d, null, c ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_function_definition",137, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
