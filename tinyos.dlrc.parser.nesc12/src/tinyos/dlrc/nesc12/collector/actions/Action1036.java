...
public final class Action1036 implements ParserAction{
 ...
 // c_selection_statement ::= K_IF c_round_open c_expression c_round_close c_statement 
            {
		...
		Statement t = (Statement)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 IfStatement result = new IfStatement( e, t, null ); RESULT = result; result.setLeft( rl.getLeft() ); 
