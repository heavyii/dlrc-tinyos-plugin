...
public final class Action282 implements ParserAction{
 ...
 // n_interface_parameters ::= c_arrow_open c_arrow_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InterfaceParameterList();
			RESULT.setRanges( rl, rr ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_interface_parameters",143, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
