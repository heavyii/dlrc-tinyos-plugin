...
public final class Action943 implements ParserAction{
 ...
 // c_parameter_list ::= c_parameter_declaration 
		...
		ParameterDeclaration i = (ParameterDeclaration)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ParameterTypeList( i ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_parameter_list",108, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
