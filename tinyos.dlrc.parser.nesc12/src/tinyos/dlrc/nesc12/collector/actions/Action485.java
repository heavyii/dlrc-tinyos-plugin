...
public final class Action485 implements ParserAction{
 ...
 // n_attribute_initializer_list ::= c_round_open c_round_close 
            {
              InitializerList RESULT =null;
		   
              CUP$parser$result = parser.getSymbolFactory().newSymbol("n_attribute_initializer_list",150, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
