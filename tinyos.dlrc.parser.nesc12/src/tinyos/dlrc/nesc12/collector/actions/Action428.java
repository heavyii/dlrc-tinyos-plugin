...
public final class Action428 implements ParserAction{
 ...
 // n_new_component_ref ::= NK_NEW c_all_identifier c_round_open n_generic_arguments c_round_close 
            {
		...
		Token rr = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NewComponent( i, g, null ); RESULT.setLeft( rl.getLeft() ); RESULT.setRight( rr.getRight() ); 
