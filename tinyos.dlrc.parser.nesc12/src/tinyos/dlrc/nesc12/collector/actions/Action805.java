...
public final class Action805 implements ParserAction{
 ...
 // c_init_declarator ::= c_declarator_typedef_name 
            {
		...
		Declarator d = (Declarator)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new InitDeclarator( d, null, null ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_init_declarator",87, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
