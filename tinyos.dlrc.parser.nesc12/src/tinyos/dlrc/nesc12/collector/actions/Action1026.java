...
public final class Action1026 implements ParserAction{
 ...
 // c_asm_args_list ::= c_asm_arg_list 
            {
              ASMArgumentsList RESULT =null;
		ASMArgumentList l = (ASMArgumentList)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ASMArgumentsList( l ); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("c_asm_args_list",28, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
