...
public final class Action623 implements ParserAction{
 ...
 // c_and_expression ::= c_and_expression P_AMP c_equality_expression 
            {
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new ArithmeticExpression( a, new ArithmeticOperator( p, ArithmeticOperator.Operator.BIT_AND ), e ); 
