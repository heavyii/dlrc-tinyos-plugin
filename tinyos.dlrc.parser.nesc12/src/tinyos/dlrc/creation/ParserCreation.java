...
import tinyos.dlrc.preprocessor.BaseFileInfo;
import tinyos.dlrc.preprocessor.Preprocessor;
import tinyos.dlrc.preprocessor.PreprocessorReader;
import tinyos.dlrc.preprocessor.lexer.Macro.VarArg;
import tinyos.dlrc.preprocessor.lexer.macro.GenericMacro;
...
public class ParserCreation {
    ...
    public static final String MAIN_PACKAGE_NAME = "tinyos.dlrc.nesc12.parser";
    ...
    public static final String MAIN_ACTION_PACKAGE_NAME = "tinyos.dlrc.nesc12.parser.actions";
    ...
    /** package into which the parser will be put */
    public static final String COLLECTOR_PACKAGE_NAME = "tinyos.dlrc.nesc12.collector";
    /** name of the directory into which the parser will be put */
    public static final String COLLECTOR_DIRECTORY_NAME = "src/" + COLLECTOR_PACKAGE_NAME.replaceAll( "\\.", "/" );
    
    /** name of the package into which the actions will be put*/
    public static final String COLLECTOR_ACTION_PACKAGE_NAME = "tinyos.dlrc.nesc12.collector.actions";
    /** name of the directory into which the actions will be put */
    ...
    public static final String[] MAIN_IMPORTS = new String[]{
        ...
        "tinyos.dlrc.nesc12.lexer.Token",
        "tinyos.dlrc.nesc12.lexer.Lexer",
        "tinyos.dlrc.nesc12.parser.ast.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.declaration.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.definition.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.error.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.expression.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.general.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.nesc.*",
        "tinyos.dlrc.nesc12.parser.ast.nodes.statement.*"
    };
    
    public static final String[] COLLECTOR_IMPORTS = new String[]{
        //"java_cup.runtime.Symbol",
        "tinyos.dlrc.nesc12.parser.StringRepository",
        "tinyos.dlrc.nesc12.parser.ScopeStack",
        "tinyos.dlrc.nesc12.parser.RawParser",
    ...
    public void runMainLexer() throws Exception{
        String dir = "src/tinyos/dlrc/nesc12/lexer";
    ...
    public void runCollectorLexer() throws Exception{
        String dir = "src/tinyos/dlrc/nesc12/collector";
        String name = "bin/data/tinyos/parser/tokens.jflex";
        String temp = "temp.jflex";
