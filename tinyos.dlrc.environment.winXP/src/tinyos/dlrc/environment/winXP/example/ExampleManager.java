 ...
 */
package tinyos.dlrc.environment.winXP.example;

import java.io.File;

import tinyos.dlrc.environment.basic.example.AbstractExampleManager;
...
public class ExampleManager extends AbstractExampleManager {
    ...
    protected File getExampleDirectory(){
    	String path = environment.getPathManager().getExampleDirectory();
