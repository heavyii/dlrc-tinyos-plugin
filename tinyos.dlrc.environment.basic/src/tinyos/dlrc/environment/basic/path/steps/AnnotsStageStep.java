...
/**
 * Searches for the safe/include/annots_state1.h file
 * @author Benjamin Sigg
 */
public class AnnotsStageStep  implements ICollectStep{
	public String getName(){
		return "AnnotsStageStep";
	}
    ...
    public void collect( IPathRequest request, IPathSet paths, ICancellation cancellation ){
        ...
        dir = dir + "/safe/include/annots_stage1.h";
