...
public class InterfacesStep extends AbstractSearchStep{
	public String getName(){
		return "InterfacesStep";
	}
    ...
    public void collect( IPathRequest request, IPathSet paths, ICancellation cancellation ){
        ...
        File directory = manager.modelToSystem( manager.getTosDirectoryPath() + "/interfaces" );
