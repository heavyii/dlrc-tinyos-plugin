 ...
 */
package tinyos.dlrc.debug.simulation.launch.configuration;
...
import tinyos.dlrc.debug.launch.configuration.AbstractTinyOSDebuggerTab;
/**
...
public class DebuggerConfigurationTab extends AbstractTinyOSDebuggerTab
{
	...
	private void setAdditionalAttributes(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute( CDTLaunchConfigConst.ATTR_DEBUGGER_ID, "tinyos.dlrc.debug.simulation.debugger.CoojaDebugger"); // TODO: hier ID des Debuggers hardcoden
