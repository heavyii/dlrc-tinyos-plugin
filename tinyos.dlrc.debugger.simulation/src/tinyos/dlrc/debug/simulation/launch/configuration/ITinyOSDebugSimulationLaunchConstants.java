...
public interface ITinyOSDebugSimulationLaunchConstants 
{
	 ...
	 */
	public static final String TINYOS_DBG_LAUNCH_SIMULATION_ID = "tinyos.dlrc.debug.simulation.launch";

	/**
	 * This is the launch type id.
	 */
	public static final String ID_LAUNCH_TINYOS_DEBUG_SIMULATION = "tinyos.dlrc.debug.launch.simulation.configurationType";
