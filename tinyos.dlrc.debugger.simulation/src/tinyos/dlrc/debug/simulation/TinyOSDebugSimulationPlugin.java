 ...
 * 
 */
package tinyos.dlrc.debug.simulation;
...
public class TinyOSDebugSimulationPlugin extends AbstractUIPlugin implements ISimulationEventListener, IDebugEventSetListener {
	...
	/**
	 * The plug-in identifier (value <code>"tinyos.dlrc.debug.simulation"</code>).
	 */
	public static final String PLUGIN_ID = "tinyos.dlrc.debug.simulation";
