 ...
 */
package tinyos.dlrc.ep.storage;
...
import tinyos.dlrc.editors.nesc.util.ConfigurationElementContent;
import tinyos.dlrc.ep.NullParseFile;
import tinyos.dlrc.ep.figures.BlockContent;
import tinyos.dlrc.ep.figures.ConfigurationContent;
import tinyos.dlrc.ep.figures.GraphContent;
import tinyos.dlrc.ep.figures.InterfaceContent;
import tinyos.dlrc.ep.figures.LabelContent;
import tinyos.dlrc.ep.figures.LazyContent;
import tinyos.dlrc.ep.figures.ModuleContent;
import tinyos.dlrc.ep.parser.EmptyTagSet;
...
import tinyos.dlrc.model.missing.IMissingResource;
import tinyos.dlrc.model.missing.MissingDeclaration;
import tinyos.dlrc.model.missing.MissingSystemFile;
import tinyos.dlrc.model.missing.MissingUserFile;
import tinyos.dlrc.model.standard.StandardFileModel;
import tinyos.dlrc.model.standard.StandardFileModel.StandardParseFile;
...
public class GenericStorage implements IStorage{
    ...
    protected void createFactories(){
        ...
        put( "tinyos.dlrc.utility.Icon", Icon.class, Icon.FACTORY );
        ...
        put( "tinyos.dlrc.ep.parser.IASTModelAttribute[]", IASTModelAttribute[].class, IASTModelAttribute.ARRAY_FACTORY );
    ...
    public <V> void write( V value ) throws IOException{
        if( value == null ){
            ...
            IGenericFactory<V> factory = (tinyos.dlrc.ep.storage.IGenericFactory<V> )factories.get( name );
            if( factory == null )
