...
/**
 * Resolution for a set of markers. When run the markers normally cease
 * to exist.
 * @author Benjamin Sigg
 */
public interface IMultiMarkerResolution{
    /** 
     ...
     * @param markers the markers to resolve
