...
/**
 * This observer gets informed whenever the {@link NesCEditor} uses the parser,
 * the observer can request additional informations from the parser.
 * @author Benjamin Sigg
 */
public interface INesCEditorParserClient{
