 ...
 */
public class NesCPairMatcher implements ICharacterPairMatcher{
    ...
    protected NesCCodeReader fReader = new NesCCodeReader();

    public NesCPairMatcher( char[] pairs ){
        fPairs = pairs;
    }
    ...
    protected int searchForOpeningPeer( int offset, int openingPeer,
            int closingPeer, IDocument document ) throws BadLocationException, IOException{
