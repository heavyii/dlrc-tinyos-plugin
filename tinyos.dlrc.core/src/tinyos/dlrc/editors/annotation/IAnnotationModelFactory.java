 ...
 */
package tinyos.dlrc.editors.annotation;

import org.eclipse.core.runtime.IPath;
import org.eclipse.jface.text.source.IAnnotationModel;

/**
 * Factory for nested c editor annotation models. Used by the nested c document provider
 * to create the annotation model for a new nested c document.
 * <p>
 * This interface is the expected interface for extensions provided for the
 * <code>"TinyOS.EditorAnnotationModelProvider"</code>
 * extension point.
 *
 * @since 3.0
 */
