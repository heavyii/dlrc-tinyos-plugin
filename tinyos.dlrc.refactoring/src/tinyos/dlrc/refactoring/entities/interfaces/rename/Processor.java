...
public class Processor extends RenameProcessor {
	...
	private tinyos.dlrc.refactoring.entities.interfaces.alias.rename.Processor aliasProcessor;
	...
	private void handleCaseInterfaceAliasInNesCComponentWiring(Identifier selectedIdentifier,IProgressMonitor monitor){
		...
		aliasProcessor=new tinyos.dlrc.refactoring.entities.interfaces.alias.rename.Processor(info);
	}
