...
public class ComponentAstAnalyzer extends NesCAstAnalyzer {
	 ...
	 * Use {@link tinyos.dlrc.refactoring.ast.AstAnalyzer#getAliasIdentifier4InterfaceAliasName(String alias) getIdentifierForInterfaceAliasName} to get the alias identifier.
	 * @param alias
	 * @return
	 */
